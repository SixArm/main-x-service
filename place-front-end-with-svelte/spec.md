# place-front-end-with-svelte — Living Specification
...
For the underlying service contract, see [`../place-service-rust-crate/spec.md`](../place-service-rust-crate/spec.md). For shared MXI guidance (REST conventions, observability, compliance), see [`../AGENTS.md`](../AGENTS.md) and [`../agents/share/`](../agents/share/).
...
| **Match quality** | `definite` / `certain` / `probable` / `possible` / `unlikely` (per `place-service-rust-crate/AGENTS/matching.md`). |
...
- **v0.3**: Auth integration (once Place Service ships auth — §15 of service spec).
...
- [`../place-service-rust-crate/spec.md`](../place-service-rust-crate/spec.md)
...
- [`../place-service-rust-crate/AGENTS/matching.md`](../place-service-rust-crate/AGENTS/matching.md)
