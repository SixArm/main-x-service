...
//!
//! Swagger UI assets are loaded from a CDN (swagger-ui-dist) to keep
//! the crate dependency-light; the spec itself is served from this
//! service.
...
<head>
  ...
  <title>Content Management System Service API</title>
