...
| [Care Pathway Service](care-pathway/care-pathway-service-rust-crate/) | Care pathway (clinical pathway) — loco.rs CRUD + matching (embeds care-pathway-matcher) + condition-code validation + OpenAPI/Swagger + audit log + event streaming | [spec](care-pathway/care-pathway-service-rust-crate/spec/index.md) | [index](care-pathway/care-pathway-service-rust-crate/index.md) |
