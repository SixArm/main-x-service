...
- Use `impl Into<String>` on builder setters (we do this already on `PersonBuilder`).
...
- Examples in doctests should compile. Use `# use person_matcher::...;` hidden imports if needed.
