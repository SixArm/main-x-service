...
impl MigrationTrait for Migration {
    ...
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        m.alter_table(
            Table::alter()
                ...
                .add_column_if_not_exists(ColumnDef::new(AuditLogs::Hash).string().null())
        ...
        m.alter_table(
            Table::alter()
                .table(Plans::Table)
                .add_column_if_not_exists(ColumnDef::new(Plans::ContentHash).string().null())
                .add_column_if_not_exists(ColumnDef::new(Plans::ContentHashSha3).string().null())
                .add_column_if_not_exists(ColumnDef::new(Plans::ContentMac).string().null())
                .to_owned(),
        )
        .await?;
        Ok(())
    ...
    async fn down(&self, m: &SchemaManager) -> Result<(), DbErr> {
        ...
        m.alter_table(
            Table::alter()
                .table(Plans::Table)
                .drop_column(Plans::ContentHash)
                .drop_column(Plans::ContentHashSha3)
                .drop_column(Plans::ContentMac)
                .to_owned(),
        )
        .await?;
        Ok(())
