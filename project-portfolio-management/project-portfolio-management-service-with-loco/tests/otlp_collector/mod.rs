...
//!
//! Ported from case-service's `tests/otlp_collector/mod.rs` (PRO-H12,
//! itself ported from care-pathway-service's, itself
//! organization-service's, itself course-service's, itself
//! link-graph-service's) — nothing here is service-specific. Shared by
