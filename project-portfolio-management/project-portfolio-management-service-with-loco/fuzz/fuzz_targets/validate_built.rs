...
//! random bytes are not a `Plan`, so the deep fields are reached only
//! once libFuzzer has learned the grammar. This target builds the `Plan`
...
use project_portfolio_management_matcher::{Goal, IdentifierScheme, Plan, PlanIdentifier};
use project_portfolio_management_service::validation;
    ...
    for (i, chunk) in chunks.enumerate() {
        ...
        match i % 5 {
            ...
            _ => {
                ...
                record.identifiers.push(PlanIdentifier {
