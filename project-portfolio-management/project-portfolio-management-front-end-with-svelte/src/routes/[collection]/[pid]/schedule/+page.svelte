<!--
  Portfolio schedule (`/portfolios/[pid]/schedule`, PPM-6): member
  timeframes as CSS bars, critical-path badges, finish-start
  violations, and undated members. Portfolios only (the service view
