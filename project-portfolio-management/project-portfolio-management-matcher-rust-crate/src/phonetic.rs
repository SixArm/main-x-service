...
///
/// The gate used by the name component's phonetic bonus. `a` and `b` are
...
mod tests {
    ...
    // Pins that non-letters are skipped.
    #[test]
    ...
    // Pins adjacent same-group consonant collapse (Jackson → J250).
    #[test]
