...
> Sibling matcher: [portfolio-matcher](../../portfolio-matcher-rust-crate/spec/index.md).
> Sibling front-end: [portfolio-front-end-with-svelte](../../portfolio-front-end-with-svelte/spec/index.md).
...
portfolio-matcher) and a project workspace (each work item *owns*
...
The API DTO is `portfolio_matcher::WorkItem` — the canonical model lives
...
> `kind` (the R-GATE, [portfolio-matcher §1–§25](../../portfolio-matcher-rust-crate/spec/index.md)).
...
matching via the embedded `portfolio-matcher` (`MatchingEngine::new(
...
parent `(kind, pid)` (§10). Matching calls `portfolio-matcher` directly
...
default** — gated by `PORTFOLIO_REQUIRE_AUTH` (`1`/`true`/`yes`/`on` ⇒
...
- The [portfolio entity spec](../../spec/index.md) (canonical model §5);
  the [portfolio-matcher spec](../../portfolio-matcher-rust-crate/spec/index.md);
