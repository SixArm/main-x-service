...
- [portfolio-service-with-loco/spec](../portfolio-service-with-loco/spec/index.md) — registry service + project-management tool (§1–§18)
- [portfolio-matcher-rust-crate/spec](../portfolio-matcher-rust-crate/spec/index.md) — matching library (§1–§25)
- [portfolio-front-end-with-svelte/spec](../portfolio-front-end-with-svelte/spec/index.md) — operator UI (§1–§18)
