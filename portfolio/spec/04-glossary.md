...
[spec §4](../portfolio-service-with-loco/spec/index.md), matcher
[spec §3](../portfolio-matcher-rust-crate/spec/index.md), front-end
[spec §4](../portfolio-front-end-with-svelte/spec/index.md).
...
| **DTO contract** | The API body for the thin record **is** `portfolio_matcher::WorkItem` — no separate service model, no adapter |
