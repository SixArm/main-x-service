...
// `portfolio_matcher::WorkItem` shape itself.
// Source of truth: portfolio-matcher-rust-crate/src/work_item.rs.
 ...
 * mirroring `portfolio_matcher::WorkItem`. `kind` and `name` are
