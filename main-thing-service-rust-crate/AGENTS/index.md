# AGENTS directory — Main Thing Service

Detailed reference documentation for the Main Thing Service system.

## Documents in this directory

| Document | Description |
|----------|-------------|
| [models.md](models.md) | Domain model reference (schema.org/Thing; shares the GLN + PostalAddress schema with the place lineage) |
