# RESTful API reference — Main Thing Service
...
use main_thing_service::models::identifier::{ThingIdentifier, IdentifierType};
use main_thing_service::models::amenity::AmenityFeature;
use main_thing_service::models::opening_hours::{OpeningHoursSpecification, DayOfWeek};
use main_thing_service::models::consent::{Consent, ConsentType, ConsentStatus};
```

### Matching

```rust
use main_thing_service::matching::scoring::{compute_match, MatchWeights, MatchResult, MatchConfidence};
...
```rust
use main_thing_service::validation::{validate_thing, normalize_thing, ValidationError};
```

### Privacy

```rust
use main_thing_service::privacy::{mask_thing, gdpr_export};
```
