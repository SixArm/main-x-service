# Main Thing Service — Specification

Source of truth for the **Main Thing Service** crate. This document
...
The Main Thing Service is a **generic asset / object registry** —
...
[person](../main-person-service-rust-crate/),
...
tier files only; this per-crate spec is local to the Main Thing Service.
