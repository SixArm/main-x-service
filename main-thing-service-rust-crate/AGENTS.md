...
| [AGENTS/models.md](AGENTS/models.md) | Domain model reference (generic asset / schema.org/Thing (current models reuse the Place schema)) |
...
| `GET /things` | Entity index (full HTML) |
| `GET /things/search/partial?q=…` | HTMX fragment for live search |
