...
use main_thing_service::models::consent::{Consent, ConsentStatus, ConsentType};
use main_thing_service::models::geo::GeoCoordinates;
use main_thing_service::models::identifier::{IdentifierType, ThingIdentifier};
use main_thing_service::models::opening_hours::{DayOfWeek, OpeningHoursSpecification};
