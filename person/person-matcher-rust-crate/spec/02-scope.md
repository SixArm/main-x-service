...
**Out of Scope (Today).** Blocking / candidate generation across large datasets; persistent main person indices; population-scale record linkage (Fellegi-Sunter EM training); external postal-address standardisation (declined per T-14); cross-scheme identity resolution.
