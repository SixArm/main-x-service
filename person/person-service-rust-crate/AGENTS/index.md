# AGENTS directory — Person Service

Detailed reference documentation for the Person Service crate.
...
| [models.md](models.md) | Domain model reference (`Person`, supporting types, invariants) |
| [matching.md](matching.md) | Matching algorithm reference (weights, components, rules) |
| [restful.md](restful.md) | REST API + FHIR R5 + library API reference |
