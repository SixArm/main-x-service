...
<script lang="ts">
    ...
    const navItems = [
        ...
        { href: "/persons/new", label: "New person" },
        { href: "/persons/match", label: "Match check" },
        { href: "/persons/merge", label: "Merge" },
    ];
</script>

<div class="layout">
    <aside class="sidebar">
        <h1 class="brand">Person<br /><span class="muted small">Main X Index</span></h1>
        <nav>
            <ul>
