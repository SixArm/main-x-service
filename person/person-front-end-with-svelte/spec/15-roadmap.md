...
- **v0.3**: Auth integration (once Person Service ships auth — §15 of service spec). BFF + httpOnly-cookie + PASETO model per [`../../../agents/share/authentication-sessions.md`](../../../agents/share/authentication-sessions.md) (no client-held bearer / `localStorage`).
