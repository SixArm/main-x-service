...
--
-- These fired AFTER INSERT/UPDATE/DELETE on persons and organizations and
...
--      persons and organizations tables, not on the child tables where
...
DROP TRIGGER IF EXISTS audit_patients_changes ON persons;
