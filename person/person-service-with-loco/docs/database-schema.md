...
This document describes the PostgreSQL database schema for the Person Service. The schema is designed to support millions of person records with high performance, HIPAA compliance, and full audit trail capabilities.
