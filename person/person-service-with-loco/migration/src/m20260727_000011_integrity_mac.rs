...
impl MigrationName for Migration {
    fn name(&self) -> &'static str {
        "m20260727_000011_integrity_mac"
    }
}
...
impl MigrationTrait for Migration {
    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared(include_str!("../../migrations/2026072700000011_integrity_mac/up.sql"))
            .await?;
        Ok(())
    }
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared(include_str!("../../migrations/2026072700000011_integrity_mac/down.sql"))
            .await?;
        Ok(())
    }
}
