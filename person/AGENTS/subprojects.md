...
|---|---|---|---|
| [person-service-rust-crate](../person-service-rust-crate/) | Rust service (loco.rs / Axum, SeaORM + PostgreSQL, Tantivy) | System of record: CRUD, search, matching, dedup, merge, audit, privacy, REST + FHIR | [spec/](../person-service-rust-crate/spec/index.md) §1–§18 |
...
|---|---|---|---|
| Living spec | [spec/](../person-service-rust-crate/spec/index.md) | [spec/](../person-matcher-rust-crate/spec/index.md) | [spec/](../person-front-end-with-svelte/spec/index.md) |
| Agent guide | [AGENTS.md](../person-service-rust-crate/AGENTS.md) + [AGENTS/](../person-service-rust-crate/AGENTS/index.md) | [AGENTS.md](../person-matcher-rust-crate/AGENTS.md) + [AGENTS/](../person-matcher-rust-crate/AGENTS/) | [AGENTS.md](../person-front-end-with-svelte/AGENTS.md) |
| User intro | [README.md](../person-service-rust-crate/README.md) | [README.md](../person-matcher-rust-crate/README.md) | [README.md](../person-front-end-with-svelte/README.md) |
| Navigation / examples | [index.md](../person-service-rust-crate/index.md) | [index.md](../person-matcher-rust-crate/index.md) | [index.md](../person-front-end-with-svelte/index.md) |
