...
A high-performance, enterprise-grade Main Patient Index system built with Rust for healthcare organizations.
...
The Main Patient Index (MPI) is a critical healthcare system that maintains a centralized registry of patient identities across multiple healthcare facilities. This production-ready implementation provides:
...
```bash
# Clone repository
git clone https://github.com/sixarm/main-patient-index-rust-crate.git
cd main-patient-index-rust-crate
...
2. Copy binary: `cp target/release/main-patient-index /opt/main-patient-index/`
3. Set up environment: `cp .env.production.example /opt/main-patient-index/.env`
4. Run migrations: `sea-orm-cli migrate up`
5. Start service: `./main-patient-index`
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/main-patient-index-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/main-patient-index-rust-crate/discussions)
