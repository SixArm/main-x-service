# Main Patient Index (MPI) - Project Index

## Overview

A high-performance Main Patient Index system built with Rust for managing centralized patient identity registries across healthcare providers.
