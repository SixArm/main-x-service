...
| [AGENTS/models.md](AGENTS/models.md) | Domain model reference (FHIR Patient) |
...
| `GET /patients` | Entity index (full HTML) |
| `GET /patients/search/partial?q=…` | HTMX fragment for live search |
