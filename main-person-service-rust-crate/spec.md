# Main Person Service — Specification

Source of truth for the **Main Person Service** crate. This document
...
The Main Person Service is a general-purpose centralised registry of
person identities. It sits alongside the more domain-specific
[Patient](../main-patient-index-rust-crate/) and
[Worker](../main-worker-service-rust-crate/) indices and exists to:
...
tier files only; this per-crate spec is local to the Main Person Service.
