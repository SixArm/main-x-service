# AGENTS directory — Main Person Service

Detailed reference documentation for the Main Person Service system.

## Documents in this directory

| Document | Description |
|----------|-------------|
| [models.md](models.md) | Domain model reference (FHIR Person; healthcare-aware) |
