# Main Person Service (MPI)

A high-performance, enterprise-grade Main Person Service system built with Rust for healthcare organizations.
...
The Main Person Service (MPI) is a critical healthcare system that maintains a centralized registry of person identities across multiple healthcare facilities. This production-ready implementation provides:

- ✅ **Person Matching**: Probabilistic and deterministic matching algorithms
...
```bash
# Clone repository
git clone https://github.com/sixarm/main-person-service-rust-crate.git
cd main-person-service-rust-crate
...
# Run specific test
cargo test test_person_matching
...
2. Copy binary: `cp target/release/main-person-service /opt/main-person-service/`
3. Set up environment: `cp .env.production.example /opt/main-person-service/.env`
4. Run migrations: `sea-orm-cli migrate up`
5. Start service: `./main-person-service`
...
```
main-person-service-rust-crate/
├── src/
│   ├── api/
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/main-person-service-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/main-person-service-rust-crate/discussions)
