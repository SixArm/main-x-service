...
| [AGENTS/models.md](AGENTS/models.md) | Domain model reference (FHIR Person; healthcare-aware) |
...
| `GET /persons` | Entity index (full HTML) |
| `GET /persons/search/partial?q=…` | HTMX fragment for live search |
