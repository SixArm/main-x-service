...
- [`../course-service-rust-crate/`](../course-service-rust-crate/) — the system of record this UI calls. Its [`spec.md`](../course-service-rust-crate/spec.md) and [`AGENTS/restful.md`](../course-service-rust-crate/AGENTS/restful.md) are the API contract.
