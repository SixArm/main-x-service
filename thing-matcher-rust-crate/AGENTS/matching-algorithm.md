...
See [`../spec.md`](../spec.md) §10 for the live list (OQ-A through OQ-D). When you have an opinion, propose a resolution in `spec.md` as a PR, not as a unilateral code change.
