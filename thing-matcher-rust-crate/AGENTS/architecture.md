...
The authoritative description of the crate's data model, scoring pipeline, and safety guarantees lives in [`../spec.md`](../spec.md) §3 and §8. This guide is the practitioner's view of the module layout and the layering rules.
