...
- Sibling crate specs: [`person-matcher/spec.md`](../../person-matcher-rust-crate/spec/index.md), [`worker-matcher/spec.md`](../../worker-matcher-rust-crate/spec/index.md), [`place-matcher/spec.md`](../../place-matcher-rust-crate/spec/index.md), [`event-matcher/spec.md`](../../event-matcher-rust-crate/spec/index.md).
