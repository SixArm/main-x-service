...
- **0.4.0** is the first release of `thing-matcher` under the geographic thing-matcher domain. The 0.3.x line targeted a different domain and is not upgrade-compatible.
