...
A high-performance, enterprise-grade Main Event Index system built with Rust for healthcare organizations.
...
The Main Event Index (MPI) is a critical healthcare system that maintains a centralized registry of event identities across multiple healthcare facilities. This production-ready implementation provides:
...
2. Copy binary: `cp target/release/main-event-index /opt/main-event-index/`
3. Set up environment: `cp .env.production.example /opt/main-event-index/.env`
4. Run migrations: `sea-orm-cli migrate up`
5. Start service: `./main-event-index`
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/main-event-index-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/main-event-index-rust-crate/discussions)
