# Main Event Index — Specification

Source of truth for the **Main Event Index** crate. This document
...
The Main Event Index is a centralised registry of **time-bounded
...
this per-crate spec is local to the Main Event Index.
