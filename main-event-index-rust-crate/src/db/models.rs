...
pub mod events {
    ...
    pub enum Relation {
        #[sea_orm(has_many = "super::event_names::Entity")]
        EventNames,
        #[sea_orm(has_many = "super::event_identifiers::Entity")]
        EventIdentifiers,
        #[sea_orm(has_many = "super::event_addresses::Entity")]
        EventAddresses,
        #[sea_orm(has_many = "super::event_contacts::Entity")]
        EventContacts,
        #[sea_orm(has_many = "super::event_links::Entity")]
        EventLinks,
        #[sea_orm(has_many = "super::event_match_scores::Entity")]
        EventMatchScores,
        #[sea_orm(
    ...
    impl Related<super::event_names::Entity> for Entity {
        fn to() -> RelationDef { Relation::EventNames.def() }
    }
    impl Related<super::event_identifiers::Entity> for Entity {
        fn to() -> RelationDef { Relation::EventIdentifiers.def() }
    }
    impl Related<super::event_addresses::Entity> for Entity {
        fn to() -> RelationDef { Relation::EventAddresses.def() }
    }
    impl Related<super::event_contacts::Entity> for Entity {
        fn to() -> RelationDef { Relation::EventContacts.def() }
    }
    impl Related<super::event_links::Entity> for Entity {
        fn to() -> RelationDef { Relation::EventLinks.def() }
    }
...
pub mod event_names {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Serialize, Deserialize)]
    #[sea_orm(table_name = "event_names")]
    pub struct Model {
        #[sea_orm(primary_key, auto_increment = false)]
        pub id: Uuid,
        pub event_id: Uuid,
...
pub mod event_contacts {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Serialize, Deserialize)]
    #[sea_orm(table_name = "event_contacts")]
    pub struct Model {
        #[sea_orm(primary_key, auto_increment = false)]
        pub id: Uuid,
        pub event_id: Uuid,
...
// ============================================================================
// Event Match Score Models
// ============================================================================

pub mod event_match_scores {
    use super::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Serialize, Deserialize)]
    #[sea_orm(table_name = "event_match_scores")]
    pub struct Model {
        #[sea_orm(primary_key, auto_increment = false)]
        pub id: Uuid,
        pub event_id: Uuid,
