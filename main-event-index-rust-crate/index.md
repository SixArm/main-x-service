# Main Event Index (MPI) - Project Index

## Overview

A high-performance Main Event Index system built with Rust for managing centralized event identity registries across healthcare providers.
