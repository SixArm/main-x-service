...
This document describes the PostgreSQL database schema for the Main Event Index (MPI) system. The schema is designed to support millions of event records with high performance, HIPAA compliance, and full audit trail capabilities.
