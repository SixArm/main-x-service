...
The MPI matching system compares two event records and produces a confidence score (0.00–1.00). Two strategies are available: probabilistic (weighted fuzzy) and deterministic (rule-based exact).
...
- Uses `Event::effective_tax_id()` (tax_id field or TAX-type identifier)
