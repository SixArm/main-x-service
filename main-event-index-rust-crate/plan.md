# Main Event Index (MPI) - Implementation Plan
...
- Bidirectional Event resource conversion
- FHIR search parameters and OperationOutcome

### Phase 7: Database Integration

- SeaOrmEventRepository with full CRUD, transactions, soft delete
- Bidirectional domain/DB model conversion

### Phase 8: Event Streaming & Audit Logging

- InMemoryEventPublisher for all event lifecycle events
...
- Event identity: tax_id, identity documents, emergency contacts
...
- Load testing at scale (millions of events)
- Query optimization
