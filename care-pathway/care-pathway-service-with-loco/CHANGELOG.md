...
`[0.2.0] - 2026-08-27` entry below still says `"1.95"` and
"current-stable-minus-three" — the policy in effect when that entry
was written, since tightened. That entry is left as-written (a dated
