...
//! its event and vice versa; a relay worker later drains unpublished rows
//! to Fluvio and stamps `published_at`.

use loco_rs::schema::*;
use sea_orm_migration::prelude::*;

/// The `event_outbox` table migration (name derived from the file name).
