...
(T-14e — `?status=all` used to mix running and completed lead times as
if they were the same kind of number), rule-based cohort splits
(T-14f), a CONSORT attrition record on every cohort response (T-14g), a
