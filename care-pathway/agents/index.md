# AGENTS directory — Care Pathway Entity

Entity-level reference documentation for the care-pathway trio:
...
| [models.md](models.md) | Domain model reference — the `CarePathway` DTO and its persistence |
...
- [`../../person/spec/index.md`](../../person/spec/index.md) — the
  mature sibling entity spec, useful as a parity reference
