...
```rust
use main_place_service_rust_crate::models::place::Place;
use main_place_service_rust_crate::models::address::PostalAddress;
use main_place_service_rust_crate::models::geo::GeoCoordinates;
use main_place_service_rust_crate::models::place_type::PlaceType;
use main_place_service_rust_crate::models::identifier::{PlaceIdentifier, IdentifierType};
use main_place_service_rust_crate::models::amenity::AmenityFeature;
use main_place_service_rust_crate::models::opening_hours::{OpeningHoursSpecification, DayOfWeek};
use main_place_service_rust_crate::models::consent::{Consent, ConsentType, ConsentStatus};
```

### Matching

```rust
use main_place_service_rust_crate::matching::scoring::{compute_match, MatchWeights, MatchResult, MatchConfidence};
use main_place_service_rust_crate::matching::name::name_similarity;
use main_place_service_rust_crate::matching::address::address_similarity;
use main_place_service_rust_crate::matching::geo::{geo_similarity, geo_similarity_with_reference, within_radius};
use main_place_service_rust_crate::matching::identifier::{identifier_similarity, has_gln_match};
use main_place_service_rust_crate::matching::phonetic::{soundex, soundex_match};
```

### Validation

```rust
use main_place_service_rust_crate::validation::{validate_place, normalize_place, ValidationError};
```

### Privacy

```rust
use main_place_service_rust_crate::privacy::{mask_place, gdpr_export};
```
