# Main Place Service (MPI) - Project Index

## Overview

A high-performance Main Place Service system built with Rust for managing centralized place identity registries. Based on [schema.org/Place](https://schema.org/Place).
