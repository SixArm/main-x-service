use main_place_service::matching::name::name_similarity;
use main_place_service::matching::address::address_similarity;
use main_place_service::matching::geo::{geo_similarity, geo_similarity_with_reference, within_radius};
use main_place_service::matching::identifier::{identifier_similarity, has_gln_match};
use main_place_service::matching::phonetic::{soundex, soundex_match};
use main_place_service::matching::scoring::{compute_match, MatchConfidence, MatchWeights};
use main_place_service::models::address::PostalAddress;
use main_place_service::models::geo::GeoCoordinates;
use main_place_service::models::identifier::{IdentifierType, PlaceIdentifier};
use main_place_service::models::place::Place;
use main_place_service::models::place_type::PlaceType;
