...
- CONTRIBUTING.md how a person can contribute their time, or update code, or donate money, etc.
- RFC.md request for comments e.g. what does this project want to learn, what kinds of constructive feedback can help, how to improve, etc.
