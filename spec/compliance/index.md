...
| Supply-chain evidence / SBOM | CycloneDX SBOM generated from the real dependency graph; advisory + licence gating already in place | `scripts/sbom.sh`, `deny.toml` (`cargo-deny`, SEC-I1) | care-pathway ✔ (generation script); **CI wiring deferred** |
