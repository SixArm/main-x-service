...
| `OTLP_SERVICE_NAME` | `<entity>-service` | OTel resource name (built, never exported — see `overview.md`'s observability note) |
| `OTLP_ENDPOINT` | `http://localhost:4317` | OTel collector endpoint (unused today, same caveat) |
