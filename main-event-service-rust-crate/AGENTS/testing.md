...
| `validation`                | 3+    | Valid event, missing family name, phone normalization, address standardization      |
| `privacy`                   | 2+    | Value masking, event masking                                                        |
| `models::event`             | 2+    | Event construction, serialization                                                   |
...
cargo test --lib test_event_matching        # Tests matching "test_event_matching"
...
| ----------------------------- | -------------------------------------------------------------- |
| `benches/matching_bench.rs`   | Name matching, full event matching, phonetic encoding          |
| `benches/search_bench.rs`     | Event indexing, full-text search, fuzzy search                 |
| `benches/validation_bench.rs` | Event validation, phone normalization, address standardization |
...
5. Use `Event::new()` for test event construction
