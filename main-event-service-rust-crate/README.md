...
A high-performance, enterprise-grade Main Event Service system built with Rust for healthcare organizations.
...
The Main Event Service (MPI) is a critical healthcare system that maintains a centralized registry of event identities across multiple healthcare facilities. This production-ready implementation provides:

- ✅ **Event Matching**: Probabilistic and deterministic matching algorithms
...
# Run specific test
cargo test test_event_matching
...
2. Copy binary: `cp target/release/main-event-service /opt/main-event-service/`
3. Set up environment: `cp .env.production.example /opt/main-event-service/.env`
4. Run migrations: `sea-orm-cli migrate up`
5. Start service: `./main-event-service`
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/main-event-service-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/main-event-service-rust-crate/discussions)
