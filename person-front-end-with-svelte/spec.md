# person-front-end-with-svelte — Living Specification
...
For the underlying service contract, see [`../person-service-rust-crate/spec.md`](../person-service-rust-crate/spec.md). For shared MXI guidance (REST conventions, observability, compliance), see [`../AGENTS.md`](../AGENTS.md) and [`../agents/share/`](../agents/share/).
...
| **Match quality** | `definite` / `certain` / `probable` / `possible` / `unlikely` (per `person-service-rust-crate/AGENTS/matching.md`). |
...
The front-end binds 1:1 to the Person Service REST surface (see [`person-service-rust-crate/AGENTS/restful.md`](../person-service-rust-crate/AGENTS/restful.md)):
...
- [x] T-2: Wire TypeScript types matching `person-service-rust-crate/AGENTS/models.md`.
...
| Match check | ✅ |
| Merge UI | ✅ |
| Unit tests | ✅ (8 tests across `client.test.ts` + `persons.test.ts`) |
| E2E smoke | ✅ (6 tests) |
...
- **v0.3**: Auth integration (once Person Service ships auth — §15 of service spec).
...
- [`../person-service-rust-crate/spec.md`](../person-service-rust-crate/spec.md)
...
- [`../person-service-rust-crate/AGENTS/matching.md`](../person-service-rust-crate/AGENTS/matching.md)
