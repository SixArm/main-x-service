...
- Sibling matcher spec: [course-matcher](../../course-matcher-rust-crate/spec/index.md).
- Front-end consumer: [course-front-end-with-svelte](../../course-front-end-with-svelte/spec/index.md) — SvelteKit + SVAR DataGrid + Lily Headless UI over this service's REST API.
