...
const STRINGS = {
    en: {
        ...
        "detail.confirmDelete": "Soft-delete this course? This cannot be undone via the UI.",
        ...
        "new.duplicatesDetected": "Duplicates detected ({n}) — review below before resubmitting.",
        // Audit log
        ...
        "results.score.deterministic": "deterministic (identifier / provider+code / same-as)",
    ...
    cy: {
        ...
        "detail.delete": "Dileu",
        "detail.confirmDelete": "Meddal-ddileu'r cwrs hwn? Ni ellir dadwneud hyn drwy'r rhyngwyneb.",
        ...
        "new.duplicatesDetected": "Canfuwyd dyblygiadau ({n}) — adolygwch isod cyn ailgyflwyno.",
        ...
        "results.score.deterministic": "penderfyniaethol (dynodydd / darparwr+cod / yr un â)",
        "grid.id": "ID",
        "grid.name": "Enw",
    ...
    es: {
        ...
        "detail.confirmDelete": "¿Eliminar de forma reversible este curso? Esto no se puede deshacer desde la interfaz.",
        ...
        "new.duplicatesDetected": "Duplicados detectados ({n}) — revise a continuación antes de reenviar.",
        ...
        "results.score.deterministic": "determinista (identificador / proveedor+código / igual que)",
        "grid.id": "ID",
        "grid.name": "Nombre",
    ...
    fr: {
        ...
        "detail.confirmDelete": "Supprimer logiquement ce cours ? Cette action est irréversible depuis l'interface.",
        ...
        "new.duplicatesDetected": "Doublons détectés ({n}) — vérifiez ci-dessous avant de resoumettre.",
        ...
        "results.score.deterministic": "déterministe (identifiant / fournisseur+code / identique à)",
        "grid.id": "ID",
        "grid.name": "Nom",
    ...
    de: {
        ...
        "detail.confirmDelete": "Diesen Kurs vorläufig löschen? Dies kann über die Oberfläche nicht rückgängig gemacht werden.",
        ...
        "new.duplicatesDetected": "Duplikate erkannt ({n}) — bitte unten prüfen, bevor erneut gesendet wird.",
        ...
        "results.score.deterministic": "deterministisch (Bezeichner / Anbieter+Code / identisch mit)",
        "grid.id": "ID",
        "grid.name": "Name",
    ...
    ar: {
        ...
        "detail.audit": "تدقيق",
        "detail.delete": "حذف",
        "detail.confirmDelete": "حذف هذه الدورة بشكل مبدئي؟ لا يمكن التراجع عن ذلك عبر الواجهة.",
        ...
        "new.duplicatesDetected": "تم اكتشاف تكرارات ({n}) — راجع أدناه قبل إعادة الإرسال.",
    ...
    ru: {
        ...
        "detail.confirmDelete": "Выполнить мягкое удаление этого курса? Это нельзя отменить через интерфейс.",
        ...
        "new.duplicatesDetected": "Обнаружены дубликаты ({n}) — проверьте ниже перед повторной отправкой.",
        ...
        "results.score.deterministic": "детерминированный (идентификатор / поставщик+код / то же, что и)",
        "grid.id": "ID",
        "grid.name": "Название",
    ...
    hi: {
        ...
        "detail.audit": "ऑडिट",
        "detail.delete": "हटाएँ",
        "detail.confirmDelete": "इस पाठ्यक्रम को सॉफ़्ट-डिलीट करें? इसे इंटरफ़ेस के माध्यम से पूर्ववत नहीं किया जा सकता।",
        ...
        "new.duplicatesDetected": "डुप्लिकेट पाए गए ({n}) — पुनः सबमिट करने से पहले नीचे समीक्षा करें।",
        ...
        "results.score.deterministic": "नियतात्मक (पहचानकर्ता / प्रदाता+कोड / के समान)",
        "grid.id": "ID",
        "grid.name": "नाम",
    ...
    bn: {
        ...
        "detail.audit": "অডিট",
        "detail.delete": "মুছুন",
        "detail.confirmDelete": "এই কোর্সটি সফট-ডিলিট করবেন? এটি ইন্টারফেসের মাধ্যমে পূর্বাবস্থায় ফেরানো যাবে না।",
        ...
        "new.duplicatesDetected": "সদৃশ শনাক্ত হয়েছে ({n}) — পুনরায় জমা দেওয়ার আগে নিচে পর্যালোচনা করুন।",
        "audit.title": "অডিট লগ",
        ...
        "results.score.deterministic": "নির্ণায়ক (শনাক্তকারী / প্রদানকারী+কোড / একই হিসেবে)",
        "grid.id": "ID",
        "grid.name": "নাম",
    ...
    pt: {
        ...
        "detail.delete": "Eliminar",
        "detail.confirmDelete": "Eliminar de forma reversível este curso? Isto não pode ser desfeito pela interface.",
        ...
        "new.duplicatesDetected": "Duplicados detetados ({n}) — reveja abaixo antes de reenviar.",
        ...
        "results.score.deterministic": "determinístico (identificador / provedor+código / igual a)",
        "grid.id": "ID",
        "grid.name": "Nome",
    ...
    id: {
        ...
        "detail.audit": "Audit",
        "detail.delete": "Hapus",
        "detail.confirmDelete": "Hapus sementara kursus ini? Ini tidak dapat dibatalkan melalui antarmuka.",
        ...
        "new.duplicatesDetected": "Duplikat terdeteksi ({n}) — tinjau di bawah sebelum mengirim ulang.",
        ...
        "results.score.deterministic": "deterministik (pengenal / penyedia+kode / sama dengan)",
        "grid.id": "ID",
        "grid.name": "Nama",
    ...
    ur: {
        ...
        "detail.confirmDelete": "اس کورس کو سافٹ ڈیلیٹ کریں؟ اسے انٹرفیس کے ذریعے واپس نہیں کیا جا سکتا۔",
        ...
        "new.duplicatesDetected": "نقول کا پتہ چلا ({n}) — دوبارہ جمع کرانے سے پہلے نیچے جائزہ لیں۔",
        "audit.title": "آڈٹ لاگ",
        ...
        "results.score.deterministic": "تعییناتی (شناخت کنندہ / فراہم کنندہ+کوڈ / اسی طرح)",
        "grid.id": "ID",
        "grid.name": "نام",
