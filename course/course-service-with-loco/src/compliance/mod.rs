//! Compliance controls: row-level integrity for course records and
//! the audit trail.
//!
//! ## What is here, and what is deliberately not
//!
//! Each course record and each `audit_log` row carries three stored
...
//! since it was written, and says nocourse about a row that was **deleted
//! wholesale**. Adding the chain is a separate, larger control and is not
//! claimed by anycourse in this module.
//!
//! ## Default off
//!
//! With no `COURSE_INTEGRITY_MAC_KEY` (or `..._KEY_FILE`)
...
/// Row-level integrity hashing over the assembled `Course` record.
