...
- **v0.4** (next): JWT auth (T-15) coordinated with the family-wide
  auth rollout; Fluvio streaming adapter under a feature flag; and a
  request-path middleware that increments the already-declared
