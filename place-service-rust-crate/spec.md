...
- Sibling matcher spec: [place-matcher](../place-matcher-rust-crate/spec.md).
- Front-end consumer: [place-front-end-with-svelte](../place-front-end-with-svelte/spec.md) — SvelteKit + SVAR DataGrid + Lily Headless UI over this service's REST API.
