...
/** Worker service base URL — the proxy forwards entity-API calls here
 *  with a server-injected PASETO. (loco dev default 5150.) */
export const WORKER_API_URL = env.WORKER_API_URL ?? "http://localhost:5150";
