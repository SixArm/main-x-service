...
Sibling to [`worker-service-rust-crate/`](../worker-service-rust-crate/). The Rust crate is the system of record; this is a thin presentation layer that calls its REST API.
...
- Authentication. Out of scope until the service ships auth (Worker Service spec §15).
