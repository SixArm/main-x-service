...
For the underlying service contract, see [`../worker-service-with-loco/spec.md`](../../worker-service-with-loco/spec/index.md). For shared MXI guidance (REST conventions, observability, compliance), see [`../../../AGENTS.md`](../../../AGENTS.md) and [`../../../agents/share/`](../../../agents/share/).
