...
For the underlying service contract, see [`../worker-service-rust-crate/spec.md`](../../worker-service-rust-crate/spec/index.md). For shared MXI guidance (REST conventions, observability, compliance), see [`../AGENTS.md`](../../AGENTS.md) and [`../agents/share/`](../../agents/share/).
...
9. [API Consumption](09-api-consumption.md)
