...
| NFR-8 | Security | SSO via the [authentication entity](../../authentication/) — RS256 JWT verified offline against JWKS; role-based access (HR-admin / credentialing-officer / read-only / service). Enforcement is queued (service §13 T-1) |
