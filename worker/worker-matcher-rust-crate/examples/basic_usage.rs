...
fn main() {
    ...
    let fr_a = Worker::builder()
        .given_name("Jean")
        .family_name("Dupont")
        .phone("01 23 45 67 89")
        .build();
    let fr_b = Worker::builder()
        .given_name("Jean")
        .family_name("Dupont")
        .phone("+33 1 23 45 67 89")
        .build();
    let fr_result = fr_engine.match_workers(&fr_a, &fr_b);
    println!(
    ...
    for (a, b) in [
        ...
        let r = nick_engine.match_workers(&p1, &p2);
        println!(
    ...
    let twin2 = Worker::builder()
        ...
        .multiple_birth(2)
        .build();
    let r = engine.match_workers(&twin1, &twin2);
    println!(
    ...
    let other_system = Worker::builder()
        .given_name("Alice")
        .family_name("Anderson")
        .add_passport_book(PassportBook::new("gb", " old book num ").unwrap())
        .build();
    let r = engine.match_workers(&dual_citizen, &other_system);
    println!(
    ...
    let collision = Worker::builder()
        .given_name("Alice")
        .family_name("Anderson")
        .add_passport_book(PassportBook::new("FR", "123456789").unwrap())
        .build();
    let r = engine.match_workers(&dual_citizen, &collision);
    println!(
