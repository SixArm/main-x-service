...
|---|---|---|---|
| [worker-service-rust-crate](../worker-service-rust-crate/) | System of record: CRUD, search, dedup, merge, audit, privacy, REST/FHIR/gRPC | Rust, loco.rs 0.16 (Axum 0.8), SeaORM + PostgreSQL 18, Tantivy, utoipa | [spec §1–§18](../worker-service-rust-crate/spec/index.md) |
...
|---|---|---|---|
| Living spec | [spec/](../worker-service-rust-crate/spec/index.md) | [spec/](../worker-matcher-rust-crate/spec/index.md) | [spec/](../worker-front-end-with-svelte/spec/index.md) |
| Agent guide | [AGENTS.md](../worker-service-rust-crate/AGENTS.md) + [AGENTS/](../worker-service-rust-crate/AGENTS/index.md) | [AGENTS.md](../worker-matcher-rust-crate/AGENTS.md) + [AGENTS/](../worker-matcher-rust-crate/AGENTS/) | [AGENTS.md](../worker-front-end-with-svelte/AGENTS.md) |
| User intro | [README](../worker-service-rust-crate/README.md) | [README](../worker-matcher-rust-crate/README.md) | [README](../worker-front-end-with-svelte/README.md) |
| Changelog | [CHANGELOG](../worker-service-rust-crate/CHANGELOG.md) | [CHANGELOG](../worker-matcher-rust-crate/CHANGELOG.md) | [CHANGELOG](../worker-front-end-with-svelte/CHANGELOG.md) |
