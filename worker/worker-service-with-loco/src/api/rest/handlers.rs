...
impl ComplianceIdentification {
    ...
    pub fn current() -> Self {
        ...
        Self {
            ...
            not_claimed: vec![
                "IEC 62304 safety classification: serving a FHIR Practitioner \
                 representation does not make this a medical device. No output drives \
                 an individual's treatment (compliance-for-healthcare.md §2.4).",
...
mod compliance_tests {
    use super::ComplianceIdentification;
    ...
    fn identification_carries_provenance() {
        ...
        assert_eq!(id.service, "worker-service");
    ...
    /// especially here, where the crate serves FHIR `Practitioner` and
    /// the inference could easily run the other way.
    #[test]
