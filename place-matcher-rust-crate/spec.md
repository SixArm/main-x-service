...
- **0.4.0** is the first release of `place-matcher` under the geographic place-matcher domain. The 0.3.x line targeted a different domain and is not upgrade-compatible.
