...
Main Worker Index (MPI) - A healthcare worker identification and matching system built with Rust. Production-ready with 15 API endpoints, 34 unit tests, and comprehensive feature set.
