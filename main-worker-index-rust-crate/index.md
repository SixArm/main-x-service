# Main Worker Index (MPI) - Project Index

## Overview

A high-performance Main Worker Index system built with Rust for managing centralized worker identity registries across healthcare providers.
