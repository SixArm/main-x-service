# Main Worker Index — Specification

Source of truth for the **Main Worker Index** crate. This document
...
The Main Worker Index is a centralised registry of **workforce and
...
tier files only; this per-crate spec is local to the Main Worker Index.
