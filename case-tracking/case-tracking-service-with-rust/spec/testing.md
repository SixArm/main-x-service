...
Run with `DATABASE_URL=postgres://…/case_tracking_test cargo test
...
cargo fmt --check
DATABASE_URL=postgres://postgres@localhost:5432/case_tracking_test cargo test
```
...
# Production build
cargo build --release
./target/release/case-tracker-service-with-rust-cli start
```
