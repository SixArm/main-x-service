...
> [`src/nhs.rs`](../case-tracker-service-with-rust/src/nhs.rs), the Svelte
> edition in [`src/lib/store/nhs.ts`](../case-tracker-front-end-with-svelte/src/lib/store/nhs.ts).
