...
| --------------------------------------------------------- | --------- | ---------------------------- |
| [`case-tracker-service-with-rust`](../case-tracker-service-with-rust/spec/index.md)     | Back-end  | Loco / Axum / Rust JSON API  |
| [`case-tracker-front-end-with-svelte`](../case-tracker-front-end-with-svelte/spec/index.md) | Front-end | SvelteKit / TypeScript client |
