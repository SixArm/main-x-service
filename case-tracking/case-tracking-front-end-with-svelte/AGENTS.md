...
[Loco JSON API sibling](../case-tracker-service-with-rust). The Svelte
...
[Loco API](../case-tracker-service-with-rust/spec/routes.md), it **must** be.
...
```bash
npm run check
USE_UPSTREAM_STUBS=1 cargo run -- start   # in ../case-tracker-service-with-rust
npm run test:e2e
```
...
1. Add the route in
   [`../case-tracker-service-with-rust/spec/routes.md`](../case-tracker-service-with-rust/spec/routes.md)
...
- [`../case-tracker-service-with-rust`](../case-tracker-service-with-rust)
