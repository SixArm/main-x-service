...
the [Loco JSON API sibling](../case-tracker-service-with-rust) that
...
1. Boot the API: from `../case-tracker-service-with-rust`,
...
1. Read [`../case-tracker-service-with-rust/spec/api-contract.md`](../case-tracker-service-with-rust/spec/api-contract.md)
