...
```bash
# In another terminal: start the Loco API (see ../case-tracker-service-with-rust/README.md)
cd ../case-tracker-service-with-rust && cargo run -- task seed && cargo run -- start
