...
[Loco JSON API sibling](../../case-tracker-service-with-rust/spec/index.md).
...
- [Root specification](../../spec/index.md) · [Loco JSON API sibling](../../case-tracker-service-with-rust/spec/index.md)
