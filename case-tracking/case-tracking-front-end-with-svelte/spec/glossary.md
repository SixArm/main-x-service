...
| LocalePicker | `@lily/locale-picker` — sets `<html lang>`/`<html dir>` from a radiogroup, persists to `localStorage`. |
| ThemePicker  | `@lily/theme-picker` — swaps `<link>` href + `<html data-theme>` to load one of `static/themes/*.css`. |
