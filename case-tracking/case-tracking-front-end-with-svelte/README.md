...
[Loco JSON API sibling](../case-tracker-service-with-rust) — it owns no
...
[`../case-tracker-service-with-rust/README.md`](../case-tracker-service-with-rust/README.md)
...
Both pickers persist via `localStorage` (`case-tracking:theme`,
`case-tracking:locale`).
