# Main Person Index - Deployment Guide

This guide covers deploying the Main Person Index (MPI) system using Docker and Docker Compose.
...
```bash
git clone https://github.com/your-org/main-person-index-rust-crate.git
...
# Tag for registry
docker tag mpi-server:latest your-registry.com/main_person_index-server:v1.0.0
```
...
# Push image
docker push your-registry.com/main_person_index-server:v1.0.0
```
...
# Pull latest image
docker pull your-registry.com/main_person_index-server:v1.0.0
