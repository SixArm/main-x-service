# Main Person Index (MPI) - Project Index

## Overview

A high-performance Main Person Index system built with Rust for managing centralized person identity registries across healthcare providers.
