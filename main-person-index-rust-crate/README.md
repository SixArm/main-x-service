# Main Person Index (MPI)

A high-performance, enterprise-grade Main Person Index system built with Rust for healthcare organizations.
...
The Main Person Index (MPI) is a critical healthcare system that maintains a centralized registry of person identities across multiple healthcare facilities. This production-ready implementation provides:
...
```bash
# Clone repository
git clone https://github.com/sixarm/main-person-index-rust-crate.git
cd main-person-index-rust-crate
...
2. Copy binary: `cp target/release/main-person-index /opt/main-person-index/`
3. Set up environment: `cp .env.production.example /opt/main-person-index/.env`
4. Run migrations: `sea-orm-cli migrate up`
5. Start service: `./main-person-index`
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/main-person-index-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/main-person-index-rust-crate/discussions)
