# Main Person Index (MPI) - Task Tracker
...
- [x] 2.1 Design PostgreSQL schema for person records (13 tables)
- [x] 2.2 Design schema for clinic/organization data
- [x] 2.3 Design person identifier cross-reference tables
- [x] 2.4 Create Diesel migrations (5 migration sets, 365 lines SQL)
- [x] 2.5 Implement Rust models/structs for person entities (27 models)
...
- [x] 3.1 Implement person matching algorithms
...
- [x] 3.4 Create person merge functionality
- [x] 3.5 Create person link/unlink functionality
- [x] 3.6 Implement person search functionality
- [x] 3.7 Add duplicate detection (real-time + batch)
- [x] 3.8 Implement person identifier management

## Phase 4: Search Engine Integration

- [x] 4.1 Set up Tantivy search index (11 fields)
- [x] 4.2 Implement person data indexing (single + bulk)
...
- [x] 5.2 Implement person CRUD endpoints (POST, GET, PUT, DELETE)
...
- [x] 5.9 Implement masked person view endpoint
- [x] 5.10 Implement audit log endpoints (person, recent, user)
...
- [x] 6.1 Implement FHIR Person resource mapping
...
- [x] 7.1 Implement DieselPersonRepository (full CRUD)
...
- [x] 7.5 Paginated active person retrieval
...
- [x] 10.3 Person CRUD tests (create, get, update, delete)
...
- [x] 13.1 Person identity: tax_id field, identity documents, emergency contacts
...
- [ ] 15.3 Person service RPC methods
