...
This document describes the PostgreSQL database schema for the Main Person Index (MPI) system. The schema is designed to support millions of person records with high performance, HIPAA compliance, and full audit trail capabilities.
