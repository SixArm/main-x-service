# Main Person Index (MPI) - Implementation Plan
...
- Bidirectional Person resource conversion
- FHIR search parameters and OperationOutcome

### Phase 7: Database Integration

- SeaOrmPersonRepository with full CRUD, transactions, soft delete
- Bidirectional domain/DB model conversion

### Phase 8: Event Streaming & Audit Logging

- InMemoryEventPublisher for all person lifecycle events
...
- Person identity: tax_id, identity documents, emergency contacts
...
- Load testing at scale (millions of persons)
- Query optimization
