# Plan Entity — Living Specification

> **Source of truth — for the cross-subproject contract.** This
> document is the canonical artefact for the **plan entity as a
...
> high-volume operational sub-resources (goals, tasks, issues, posts,
> comments, members), and entity-wide goals. Each subproject's own
...
> the canonical `Plan` domain model and the sub-resource partition;
> the matcher and service crate specs reference §5 rather than
> redefining it.
>
...
- [plan-service-with-loco/spec](../plan-service-with-loco/spec/index.md) — registry service + project-management tool (§1–§18)
- [plan-matcher-rust-crate/spec](../plan-matcher-rust-crate/spec/index.md) — matching library (§1–§25)
- [plan-front-end-with-svelte/spec](../plan-front-end-with-svelte/spec/index.md) — operator UI (§1–§18)
