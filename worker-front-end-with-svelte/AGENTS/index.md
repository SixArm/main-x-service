# AGENTS directory — worker-front-end-with-svelte

Detailed reference documentation for the Worker Service front-end.
...
| [testing.md](testing.md) | Vitest unit + Playwright smoke strategy |
...
| [../index.md](../index.md) | Navigation + worked flow examples |

## Sibling service docs (the API contract)

| Document | Description |
|---|---|
| [../../worker-service-rust-crate/spec.md](../../worker-service-rust-crate/spec.md) | Service spec — system of record |
