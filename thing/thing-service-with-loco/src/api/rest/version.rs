...
//! (`/api/things`, never `/api/v1/things`), and a client selects the
//! representation version with `Accepts-version: 1.0`. This module is
//! copied from the event service's reference implementation.
//!
...
mod tests {
    ...
    fn only_api_paths_are_versioned() {
        ...
        assert!(is_versioned_path("/api/things"));
