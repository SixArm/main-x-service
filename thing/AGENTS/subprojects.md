...
```
thing-front-end-with-svelte ──REST──> thing-service-rust-crate ──Cargo dep──> thing-matcher-rust-crate
```
...
|---|---|---|---|---|
| [thing-service-rust-crate](../thing-service-rust-crate/) | System of record: REST CRUD, search, dedup, merge, audit, privacy, events | loco.rs 0.16 / Axum 0.8, SeaORM + PostgreSQL, Tantivy 0.22, Tonic stub, utoipa | [spec/](../thing-service-rust-crate/spec/index.md) (§1–§18) | [AGENTS/](../thing-service-rust-crate/AGENTS/index.md), [README](../thing-service-rust-crate/README.md) |
...
- **Service** owns persistence, the REST contract, validation,
  ...
  through [`src/matching/adapter.rs`](../thing-service-rust-crate/src/matching/adapter.rs)
