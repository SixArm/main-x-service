...
`adobe-spectrum`, `mozilla-protocol`,
`united-kingdom-government-digital-service`, and
`united-states-web-design-system`) and `SIZES`/`SIZE_LABELS` (a custom
4-step `small`/`medium`/`large`/`x-large` scale) arrays; `PickerBar`
