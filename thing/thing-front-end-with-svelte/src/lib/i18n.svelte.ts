...
export const STRINGS = {
    en: {
        ...
        "detail.confirmDelete": "Soft-delete this thing? This cannot be undone via the UI.",
    ...
    cy: {
        ...
        "detail.delete": "Dileu",
        "detail.confirmDelete": "Meddal-ddileu'r peth hwn? Ni ellir ei ddadwneud drwy'r rhyngwyneb.",
    ...
    es: {
        ...
        "detail.confirmDelete": "¿Eliminar de forma reversible esta cosa? No se puede deshacer desde la interfaz.",
        ...
        "new.duplicatesDetected": "Se detectaron duplicados ({count}) — revise abajo antes de reenviar.",
    ...
    fr: {
        ...
        "detail.confirmDelete": "Supprimer logiquement cette chose ? Action irréversible via l'interface.",
    ...
    de: {
        ...
        "detail.confirmDelete": "Dieses Ding logisch löschen? Über die Oberfläche nicht rückgängig zu machen.",
        ...
        "new.duplicatesDetected": "Duplikate erkannt ({count}) — bitte unten prüfen, bevor Sie erneut senden.",
    ...
    ar: {
        ...
        "detail.audit": "تدقيق",
        "detail.delete": "حذف",
        "detail.confirmDelete": "حذف هذا الشيء حذفًا مبدئيًا؟ لا يمكن التراجع عنه عبر الواجهة.",
        ...
        "new.duplicatesDetected": "تم اكتشاف نسخ مكررة ({count}) — راجع أدناه قبل إعادة الإرسال.",
    ...
    ru: {
        ...
        "detail.confirmDelete": "Выполнить мягкое удаление этой вещи? Это нельзя отменить через интерфейс.",
    ...
    hi: {
        ...
        "detail.audit": "ऑडिट",
        "detail.delete": "हटाएँ",
        "detail.confirmDelete": "इस वस्तु को सॉफ़्ट-डिलीट करें? इसे इंटरफ़ेस से पूर्ववत नहीं किया जा सकता।",
    ...
    zh: {
        ...
        "new.duplicatesDetected": "检测到重复项（{count}）— 重新提交前请在下方查看。",
        "match.title": "匹配检查",
        "match.name": "名称",
        "match.threshold": "阈值",
        "match.thresholdHint": "0.0 – 1.0",
    ...
    bn: {
        ...
        "detail.audit": "অডিট",
        "detail.delete": "মুছুন",
        "detail.confirmDelete": "এই জিনিসটি সফট-ডিলিট করবেন? এটি ইন্টারফেসের মাধ্যমে পূর্বাবস্থায় ফেরানো যাবে না।",
    ...
    pt: {
        ...
        "detail.delete": "Eliminar",
        "detail.confirmDelete": "Eliminar esta coisa de forma reversível? Não pode ser desfeito pela interface.",
        ...
        "new.duplicatesDetected": "Duplicatas detectadas ({count}) — revise abaixo antes de reenviar.",
    ...
    id: {
        ...
        "detail.audit": "Audit",
        "detail.delete": "Hapus",
        "detail.confirmDelete": "Hapus-lunak benda ini? Tindakan ini tidak dapat dibatalkan melalui antarmuka.",
    ...
    ur: {
        ...
        "detail.confirmDelete": "اس شے کو نرم حذف کریں؟ اسے انٹرفیس کے ذریعے واپس نہیں کیا جا سکتا۔",
