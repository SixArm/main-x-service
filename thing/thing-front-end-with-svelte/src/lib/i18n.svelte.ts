...
export const STRINGS = {
  ...
  ru: {
    ...
    "things.maskSensitive": "Скрыть чувствит.",
    "things.previousPage": "Назад",
    "things.nextPage": "Далее",
    "things.pageRange": "{from}–{to} из {total}",
  ...
  bn: {
    ...
    "things.maskSensitive": "সংবেদনশীল মাস্ক করুন",
    "things.previousPage": "পূর্ববর্তী",
    "things.nextPage": "পরবর্তী",
    "things.pageRange": "{total}-এর মধ্যে {from}–{to}",
  ...
  pt: {
    ...
    "things.fuzzy": "Difusa",
    "things.phonetic": "Fonética (Soundex)",
    "things.maskSensitive": "Mascarar sensível",
    "things.previousPage": "Anterior",
    "things.nextPage": "Próximo",
    "things.pageRange": "{from}–{to} de {total}",
  ...
  id: {
    ...
    "things.maskSensitive": "Sembunyikan sensitif",
    "things.previousPage": "Sebelumnya",
    "things.nextPage": "Berikutnya",
    "things.pageRange": "{from}–{to} dari {total}",
  ...
  ur: {
    ...
    "things.maskSensitive": "حساس چھپائیں",
    "things.previousPage": "پچھلا",
    "things.nextPage": "اگلا",
    "things.pageRange": "{total} میں سے {from}–{to}",
