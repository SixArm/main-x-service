...
[service §4](../thing-service-with-loco/spec/04-glossary.md),
...
| **System of record** | `thing-service-with-loco` — owns persistence, audit, and the REST contract |
...
| **DTO contract** | The projection `to_matcher_thing(&service::Thing) -> thing_matcher::Thing` in [`adapter.rs`](../thing-service-with-loco/src/matching/adapter.rs) — see §5.3 |
| **Bridge tests** | [`tests/duplicate_detection.rs`](../thing-service-with-loco/tests/duplicate_detection.rs) — black-box tests pinning both sides of the DTO contract |
