...
|---|---|---|
| service | ~100 unit tests (`cargo test --lib`), `tests/integration_*.rs`, Criterion benchmarks, CI (`test.yml`, `quality.yml`, `security.yml`) | [service `AGENTS/testing.md`](../thing-service-rust-crate/AGENTS/testing.md) |
