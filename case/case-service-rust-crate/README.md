...
| GET | `/api/cases/whoami` | Verified bearer-token claims |
...
offline RS256 JWT verification. Tantivy full-text search, durable event
bus, and privacy are tracked in [spec §13](./spec/index.md). JWT auth is
