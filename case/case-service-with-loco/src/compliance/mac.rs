...
pub const KEY_ENV: &str = "CASE_INTEGRITY_MAC_KEY";
...
mod tests {
    ...
    fn derivation_matches_independent_hkdf_vectors() {
        ...
        let cases = [
            (
                Domain::AuditChain,
                "c7bbe060005d457d79f4d84d8b545cb9f8c858f124205ccfda1d21b79e1898f9",
                "59ca3b53ee4264e55c8cb46b1d67c255d62c46cf8734d316440a88bb0410e7de",
            ),
            (
                Domain::Record,
                "a6a6594868a3b5b2bb29a8aa2389d85711ee5482e8c660bbc290a4447ca55dbb",
                "e89a19ae39b19109ca41523b2a2ac3e7d319b77ea34d4916cdfda109f32634e4",
            ),
            (
                Domain::Checkpoint,
                "1042d72d48d6f3c0220399346d4cae6d45048529beac9502111be447c817e7bd",
                "7e0d5556c7a33e05baaeccfe9e503162e41742f502b43ae142fb11ec6305adb7",
            ),
        ];
    ...
    fn a_tag_does_not_transfer_between_services() {
        ...
        hk.expand(b"mxi/care-pathway-service/audit-chain/d1", &mut sibling_key)
            .expect("valid length");
