# AGENTS directory — Case Matcher

| Document | Description |
|---|---|
| [spec-driven-development.md](spec-driven-development.md) | SDD discipline — three-part PRs, anti-patterns |
| [matching-algorithm.md](matching-algorithm.md) | The algorithm — components, weights, deterministic rules |
...
- [`../../case-service-with-loco/`](../../case-service-with-loco/) — embedding service
- [`../../case-front-end-with-svelte/`](../../case-front-end-with-svelte/) — front-end consumer
