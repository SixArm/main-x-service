# AGENTS directory — event-front-end-with-svelte

Detailed reference documentation for the Event Service front-end.
...
| Document | Description |
|---|---|
| [../../event-service-rust-crate/spec.md](../../event-service-rust-crate/spec.md) | Service spec — system of record |
