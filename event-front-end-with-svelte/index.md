...
- [`../event-service-rust-crate/`](../event-service-rust-crate/) — the system of record this UI calls. Its [`spec.md`](../event-service-rust-crate/spec.md) and [`AGENTS/restful.md`](../event-service-rust-crate/AGENTS/restful.md) are the API contract.
