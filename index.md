...
|--------|---------|---------|-----------|----------|
| Person | [person-service-with-loco](person/person-service-with-loco/) | [person-matcher-rust-crate](person/person-matcher-rust-crate/) | [person-front-end-with-svelte](person/person-front-end-with-svelte/) | [spec](person/spec/index.md) |
| Worker | [worker-service-with-loco](worker/worker-service-with-loco/) | [worker-matcher-rust-crate](worker/worker-matcher-rust-crate/) | [worker-front-end-with-svelte](worker/worker-front-end-with-svelte/) | [spec](worker/spec/index.md) |
| Place | [place-service-with-loco](place/place-service-with-loco/) | [place-matcher-rust-crate](place/place-matcher-rust-crate/) | [place-front-end-with-svelte](place/place-front-end-with-svelte/) | [spec](place/spec/index.md) |
| Thing | [thing-service-with-loco](thing/thing-service-with-loco/) | [thing-matcher-rust-crate](thing/thing-matcher-rust-crate/) | [thing-front-end-with-svelte](thing/thing-front-end-with-svelte/) | [spec](thing/spec/index.md) |
| Event | [event-service-with-loco](event/event-service-with-loco/) | [event-matcher-rust-crate](event/event-matcher-rust-crate/) | [event-front-end-with-svelte](event/event-front-end-with-svelte/) | [spec](event/spec/index.md) |
| Course | [course-service-with-loco](course/course-service-with-loco/) | [course-matcher-rust-crate](course/course-matcher-rust-crate/) | [course-front-end-with-svelte](course/course-front-end-with-svelte/) | [spec](course/spec/index.md) |
| Organization | [organization-service-with-loco](organization/organization-service-with-loco/) | [organization-matcher-rust-crate](organization/organization-matcher-rust-crate/) | [organization-front-end-with-svelte](organization/organization-front-end-with-svelte/) | [spec](organization/spec/index.md) |
| Care pathway | [care-pathway-service-with-loco](care-pathway/care-pathway-service-with-loco/) | [care-pathway-matcher-rust-crate](care-pathway/care-pathway-matcher-rust-crate/) | [care-pathway-front-end-with-svelte](care-pathway/care-pathway-front-end-with-svelte/) | [spec](care-pathway/spec/index.md) |
| Authentication | [authentication-service-with-loco](authentication/authentication-service-with-loco/) | [authentication-verifier-rust-crate](authentication/authentication-verifier-rust-crate/) | [authentication-front-end-with-svelte](authentication/authentication-front-end-with-svelte/) | [spec](authentication/spec/index.md) |
