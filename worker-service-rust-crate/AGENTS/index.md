# AGENTS directory — Worker Service

Detailed reference documentation for the Worker Service crate.
...
| [models.md](models.md) | Domain model reference (`Worker`, supporting types, invariants) |
