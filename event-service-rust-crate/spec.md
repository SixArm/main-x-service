...
- Sibling matcher spec: [event-matcher](../event-matcher-rust-crate/spec.md).
- Front-end consumer: [event-front-end-with-svelte](../event-front-end-with-svelte/spec.md) — SvelteKit + SVAR DataGrid + Lily Headless UI over this service's REST API.
