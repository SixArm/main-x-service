...
A high-performance, enterprise-grade Event Service system built with Rust for healthcare organizations.
...
The Event Service (MPI) is a critical healthcare system that maintains a centralized registry of event identities across multiple healthcare facilities. This production-ready implementation provides:
...
- **Issues**: [GitHub Issues](https://github.com/sixarm/event-service-rust-crate/issues)
- **Discussions**: [GitHub Discussions](https://github.com/sixarm/event-service-rust-crate/discussions)
