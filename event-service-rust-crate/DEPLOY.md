...
This guide covers deploying the Event Service (MPI) system using Docker and Docker Compose.
...
# Tag for registry
docker tag mpi-server:latest your-registry.com/event_service-server:v1.0.0
```
