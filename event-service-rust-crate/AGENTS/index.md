# AGENTS directory — Event Service

Detailed reference documentation for the Event Service crate.
...
| [models.md](models.md) | Domain model reference (schema.org/Event-aligned, supporting types, invariants) |
