...
//!
//! Swagger UI assets load from a CDN (swagger-ui-dist) to keep the crate
//! dependency-light; the spec itself is served from this service.
...
<head>
  ...
  <title>Authentication Service API</title>
...
/// Routes for the API documentation: the raw `OpenAPI` JSON and the Swagger
