...
const CONFIG: KeyConfig = KeyConfig::new(env!("CARGO_PKG_NAME"), "EVENT");

/// Environment variable holding the active MAC **root** key, hex-encoded.
pub const KEY_ENV: &str = "EVENT_INTEGRITY_MAC_KEY";
