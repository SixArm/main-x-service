//! Compliance controls: row-level integrity for event records and
//! the audit trail.
//!
//! ## What is here, and what is deliberately not
//!
//! Each event record and each `audit_log` row carries three stored
...
//! ## Default off
//!
//! With no `EVENT_INTEGRITY_MAC_KEY` (or `..._KEY_FILE`)
...
/// Row-level integrity hashing over the assembled `Event` record.
