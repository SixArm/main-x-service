...
const STRINGS = {
    en: {
        ...
        "detail.confirmDelete": "Soft-delete this event? This cannot be undone via the UI.",
        // Edit event
    ...
    cy: {
        ...
        "detail.ticket": "Tocyn",
        "detail.confirmDelete": "Meddal-ddileu'r digwyddiad hwn? Ni ellir ei ddadwneud trwy'r rhyngwyneb.",
    ...
    es: {
        ...
        "events.searchPlaceholder": "Buscar por nombre, organizador, identificador…",
        ...
        "new.duplicatesDetected": "Duplicados detectados ({n}) — revísalos abajo antes de reenviar.",
        ...
        "detail.confirmDelete": "¿Eliminar este evento de forma reversible? No se puede deshacer desde la interfaz.",
    ...
    fr: {
        ...
        "events.searchPlaceholder": "Rechercher par nom, organisateur, identifiant…",
        ...
        "new.duplicatesDetected": "Doublons détectés ({n}) — vérifiez ci-dessous avant de renvoyer.",
        ...
        "detail.confirmDelete": "Supprimer cet événement de façon réversible ? Cela ne peut pas être annulé via l'interface.",
    ...
    de: {
        ...
        "new.duplicatesDetected": "Duplikate erkannt ({n}) — vor dem erneuten Senden unten prüfen.",
        ...
        "merge.idsMustDiffer": "Haupt- und Duplikat-Datensatz müssen sich unterscheiden",
        ...
        "detail.ticket": "Ticket",
        "detail.confirmDelete": "Dieses Ereignis per Soft-Delete löschen? Dies kann über die Oberfläche nicht rückgängig gemacht werden.",
    ...
    ar: {
        ...
        "new.duplicatesDetected": "تم اكتشاف تكرارات ({n}) — راجعها أدناه قبل إعادة الإرسال.",
        ...
        "detail.ticket": "تذكرة",
        "detail.confirmDelete": "هل تريد حذف هذا الحدث حذفًا ناعمًا؟ لا يمكن التراجع عن ذلك عبر الواجهة.",
    ...
    ru: {
        ...
        "events.searchPlaceholder": "Поиск по названию, организатору, идентификатору…",
        ...
        "detail.ticket": "Билет",
        "detail.confirmDelete": "Мягко удалить это событие? Это нельзя отменить через интерфейс.",
    ...
    hi: {
        ...
        "new.duplicatesDetected": "डुप्लिकेट मिले ({n}) — पुनः सबमिट करने से पहले नीचे समीक्षा करें।",
        ...
        "detail.offers": "ऑफ़र",
        "detail.ticket": "टिकट",
        "detail.confirmDelete": "इस इवेंट को सॉफ़्ट-डिलीट करें? इसे UI के माध्यम से पूर्ववत नहीं किया जा सकता।",
    ...
    bn: {
        ...
        "detail.offers": "অফার",
        "detail.ticket": "টিকিট",
        "detail.confirmDelete": "এই ইভেন্টটি সফট-ডিলিট করবেন? UI-এর মাধ্যমে এটি পূর্বাবস্থায় ফেরানো যাবে না।",
    ...
    pt: {
        ...
        "new.duplicatesDetected": "Duplicados detectados ({n}) — revise abaixo antes de reenviar.",
        ...
        "detail.confirmDelete": "Excluir este evento de forma reversível? Não pode ser desfeito pela interface.",
        "edit.title": "Editar evento",
        "edit.cancel": "Cancelar",
    ...
    id: {
        ...
        "events.searchPlaceholder": "Cari berdasarkan nama, penyelenggara, pengenal…",
        ...
        "merge.confirm": "Gabungkan {dup}… ke dalam {main}…?\nIni menghapus duplikat secara lunak.",
        ...
        "detail.ticket": "Tiket",
        "detail.confirmDelete": "Hapus acara ini secara lunak? Ini tidak dapat dibatalkan melalui antarmuka.",
    ...
    ur: {
        ...
        "detail.ticket": "ٹکٹ",
        "detail.confirmDelete": "اس ایونٹ کو نرم طور پر حذف کریں؟ اسے UI کے ذریعے واپس نہیں کیا جا سکتا۔",
