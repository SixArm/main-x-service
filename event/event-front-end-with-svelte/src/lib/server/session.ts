 ...
 * purpose is submitting a mutation (create/edit/merge) — read/list/search/
 * view pages stay public, mirroring the backend's own default-allow-read /
 * mutation-deny ABAC posture (`agents/share/authorization-attributes.md`
 * §5) rather than inventing a separate front-end policy.
 *
 ...
 * backend's own `EVENT_REQUIRE_AUTH` + ABAC guard is what actually
