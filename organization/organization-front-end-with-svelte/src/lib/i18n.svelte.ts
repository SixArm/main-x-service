...
const STRINGS = {
  ...
  ru: {
    ...
    "merge.confirm": "Объединить {dup} с {main}? Дубликат будет мягко удалён.",
    "review.intro":
      "Сохранённая очередь возможных дубликатов из пакетных проверок. Просмотрите каждую пару и подтвердите или отклоните её.",
    "review.filter.status": "Статус",
    "review.filter.statusAll": "Все статусы",
    "review.filter.limit": "Размер страницы",
    "review.filter.limitHint":
      "Смещения страниц нет — показаны только самые новые подходящие записи в пределах этого лимита.",
    ...
    "review.compare.partial":
      "Одну запись не удалось загрузить (возможно, она удалена); показано доступное.",
    ...
    "review.decide.locked":
      "По этому элементу уже принято решение, изменить его здесь нельзя.",
    "review.merge.title": "Объединение",
    "review.merge.note":
      "Подтверждение не объединяет записи — выберите, какая из них сохранится.",
  ...
  bn: {
    ...
    "review.intro":
      "ব্যাচ স্ক্যান থেকে সংরক্ষিত সম্ভাব্য ডুপ্লিকেট সারি। প্রতিটি জোড়া পর্যালোচনা করে নিশ্চিত বা প্রত্যাখ্যান করুন।",
    "review.filter.status": "অবস্থা",
    "review.filter.statusAll": "সব অবস্থা",
    "review.filter.limit": "পৃষ্ঠার আকার",
    "review.filter.limitHint":
      "কোনো পৃষ্ঠা অফসেট নেই — এই সীমা পর্যন্ত শুধুমাত্র সর্বশেষ মিলিত আইটেমগুলি দেখানো হয়।",
    ...
    "review.compare.partial":
      "একটি রেকর্ড লোড করা যায়নি (এটি মুছে ফেলা হয়ে থাকতে পারে); যা পাওয়া যাচ্ছে তা দেখানো হচ্ছে।",
    ...
    "review.decide.locked":
      "এই আইটেমটি ইতিমধ্যে সিদ্ধান্ত নেওয়া হয়েছে এবং এখানে পরিবর্তন করা যাবে না।",
    "review.merge.title": "একত্রীকরণ",
    "review.merge.note":
      "নিশ্চিত করলে রেকর্ড একত্র হয় না — কোনটি থাকবে তা বেছে নিন।",
  ...
  pt: {
    ...
    "review.intro":
      "A fila armazenada de possíveis duplicatas das varreduras em lote. Revise cada par e confirme ou rejeite-o.",
    "review.filter.status": "Status",
    "review.filter.statusAll": "Todos os status",
    "review.filter.limit": "Tamanho da página",
    "review.filter.limitHint":
      "Não há deslocamento de página — apenas os itens correspondentes mais recentes até este limite são exibidos.",
    ...
    "review.compare.partial":
      "Não foi possível carregar um registro (pode ter sido excluído); mostrando o que está disponível.",
    "review.compare.field": "Campo",
    "review.compare.a": "A",
    "review.compare.b": "B",
    ...
    "review.decide.deciding": "Registrando…",
    "review.decide.locked":
      "Este item já foi decidido e não pode ser alterado aqui.",
    "review.merge.title": "Mesclar",
    "review.merge.note":
      "Confirmar não mescla os registros — escolha qual deles permanece.",
  ...
  id: {
    ...
    "merge.confirm": "Gabungkan {dup} ke {main}? Duplikat akan dihapus lunak.",
    "review.intro":
      "Antrean kandidat duplikat tersimpan dari pemindaian batch. Tinjau setiap pasangan lalu konfirmasi atau tolak.",
    "review.filter.status": "Status",
    "review.filter.statusAll": "Semua status",
    "review.filter.limit": "Ukuran halaman",
    "review.filter.limitHint":
      "Tidak ada offset halaman — hanya item yang paling baru cocok hingga batas ini yang ditampilkan.",
    ...
    "review.compare.partial":
      "Satu catatan tidak dapat dimuat (mungkin telah dihapus); menampilkan yang tersedia.",
    ...
    "review.decide.locked":
      "Item ini sudah diputuskan dan tidak dapat diubah di sini.",
    "review.merge.title": "Gabungkan",
    "review.merge.note":
      "Mengonfirmasi tidak menggabungkan catatan — pilih mana yang tetap ada.",
  ...
  ur: {
    ...
    "merge.confirm": "کیا {dup} کو {main} میں ضم کریں؟ نقل نرم حذف ہو جائے گی۔",
    "review.intro":
      "بیچ اسکینز سے محفوظ شدہ ممکنہ نقول کی قطار۔ ہر جوڑے کا جائزہ لیں اور اسے تصدیق یا مسترد کریں۔",
    "review.filter.status": "حالت",
    "review.filter.statusAll": "تمام حالتیں",
    "review.filter.limit": "صفحہ کا سائز",
    "review.filter.limitHint":
      "کوئی صفحہ آفسیٹ نہیں ہے — صرف اس حد تک تازہ ترین مماثل اندراجات دکھائے جاتے ہیں۔",
    ...
    "review.compare.partial":
      "ایک ریکارڈ لوڈ نہیں ہو سکا (ہو سکتا ہے حذف کر دیا گیا ہو)؛ جو دستیاب ہے وہ دکھایا جا رہا ہے۔",
    ...
    "review.decide.locked":
      "اس آئٹم پر پہلے ہی فیصلہ ہو چکا ہے اور اسے یہاں تبدیل نہیں کیا جا سکتا۔",
    "review.merge.title": "ضم کریں",
    "review.merge.note":
      "تصدیق کرنے سے ریکارڈز ضم نہیں ہوتے — منتخب کریں کہ کون سا باقی رہے گا۔",
