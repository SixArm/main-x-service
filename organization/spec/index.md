# Organization Entity — Living Specification

> **Source of truth — for the cross-subproject contract.** This
> document is the canonical artefact for the **organization entity as
> a whole**: how the trio composes (front-end → service REST API →
> embedded matcher), the DTO contract (the API DTO **is** the
> matcher's `Organization` type, persisted verbatim as JSONB), shared
