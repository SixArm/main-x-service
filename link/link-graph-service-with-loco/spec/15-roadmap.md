...
- Reconciliation worker + divergence metric (T-20); Prometheus metrics
  (T-21); tracing / OTLP / health (T-22 — **done**: OTLP landed
  2026-08-05, the family's first working exporter, and the Podman
  `HEALTHCHECK` + non-root `USER` container hardening was already in
  the `Dockerfile` from 2026-08-03 — corrected 2026-08-29, PRO-P25).
