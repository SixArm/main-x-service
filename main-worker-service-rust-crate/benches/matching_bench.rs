...
use main_worker_service::models::*;
use main_worker_service::matching::*;
use main_worker_service::matching::algorithms::{
    name_matching, dob_matching, gender_matching,
    address_matching,
    tax_id_matching, document_matching,
};
use main_worker_service::matching::phonetic;
use main_worker_service::config::MatchingConfig;
