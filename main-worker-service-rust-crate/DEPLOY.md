# Main Worker Service - Deployment Guide

This guide covers deploying the Main Worker Service (MPI) system using Docker and Docker Compose.
...
```bash
git clone https://github.com/your-org/main-worker-service-rust-crate.git
...
# Tag for registry
docker tag mpi-server:latest your-registry.com/main_worker_service-server:v1.0.0
```
...
# Push image
docker push your-registry.com/main_worker_service-server:v1.0.0
```
...
# Pull latest image
docker pull your-registry.com/main_worker_service-server:v1.0.0
