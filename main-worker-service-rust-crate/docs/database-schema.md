...
This document describes the PostgreSQL database schema for the Main Worker Service (MPI) system. The schema is designed to support millions of worker records with high performance, HIPAA compliance, and full audit trail capabilities.
