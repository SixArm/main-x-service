# Main Worker Service (MPI) - Project Index

## Overview

A high-performance Main Worker Service system built with Rust for managing centralized worker identity registries across healthcare providers.
