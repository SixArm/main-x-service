# Main Place Index — Specification

Source of truth for the **Main Place Index** crate. This document
...
The Main Place Index is a centralised registry of **geographic
...
tier files only; this per-crate spec is local to the Main Place Index.
