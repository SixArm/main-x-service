...
const STRINGS = {
  ...
  pt: {
    ...
    "contact.withdraw": "Retirar",
    "contact.subjectAccess": "Baixar meus dados",
    "contact.erase": "Apagar (anonimizar)",
    "contact.eraseConfirm": "Apagar este contato? Isso não pode ser desfeito.",
  ...
  ur: {
    ...
    "contact.subjectAccess": "میرا ڈیٹا ڈاؤن لوڈ کریں",
    "contact.erase": "مٹا دیں (ناشناس کریں)",
    "contact.eraseConfirm": "اس رابطے کو مٹا دیں؟ اسے کالعدم نہیں کیا جا سکتا۔",
    "lead.score": "اسکور",
