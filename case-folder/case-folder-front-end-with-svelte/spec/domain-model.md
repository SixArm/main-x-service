...
> owned by the API: [Loco domain-model](../../case-folder-service-with-rust/spec/domain-model.md)
> and [Loco api-contract](../../case-folder-service-with-rust/spec/api-contract.md).
