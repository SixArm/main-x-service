...
const STRINGS = {
    ...
    de: {
        ...
        'dashboard.inTransit.one':
            'Sie haben {n} Akte derzeit im Transit. Nutzen Sie die Seite',
        'dashboard.inTransit.other':
            'Sie haben {n} Akten derzeit im Transit. Nutzen Sie die Seite',
        ...
        'login.sentBody':
            'mit einem bekannten Konto übereinstimmt, ist ein Anmeldelink unterwegs. Der Link läuft in 10 Minuten ab.',
        ...
        'callback.completing':
            'Einen Moment — Ihre Anmeldung wird abgeschlossen…',
        ...
        'scan.fieldDescription':
            'NHS-Nummer (z. B. 943 476 5919) oder eine Akten-ID.',
        ...
        'move.selectFolderError':
            'Wählen Sie, welche Akte verschoben werden soll.',
        'move.pickFolderDescription':
            'Wählen Sie, welche der Akten dieses Patienten verschoben werden soll.',
        'move.enterNhsDescription':
            'Geben Sie eine NHS-Nummer ein, um Akten zu sehen.',
        'move.selectFolderOption': '— Akte wählen —',
        'move.destination': 'Ziel',
        'move.workerLabel': 'Mitarbeiter (vom Haupt-Mitarbeiterdienst)',
        'move.workerDescription':
            'Wählen Sie einen registrierten Mitarbeiter, oder lassen Sie leer, um das Freitextfeld unten zu nutzen.',
        'move.freeTextOnly': '— Nur Freitext —',
        'move.movedByLabel': 'Verschoben von (Freitext)',
        'move.movedByDescription':
            'Wird verwendet, wenn kein Mitarbeiter ausgewählt ist.',
        ...
        'move.enterValidNhs':
            'Geben Sie eine gültige NHS-Nummer ein, um die Akten dieses Patienten zu sehen.',
        'move.folderNotFound': 'Akte nicht gefunden.',
        'move.recordedSummary':
            'Bewegung von {patient} erfasst — {folder} von {from} nach {to}.',
        'folders.register': 'Aktenregister',
        'folders.searchPlaceholder':
            'Suche nach NHS-Nummer, Patient, Aktentitel oder Schrank',
        'folders.searchLabel': 'Akten durchsuchen',
        'folders.addFolder': 'Akte hinzufügen',
        'folders.tableLabel': 'Akten',
        'folders.tableCaption':
            'Alle vom System erfassten Papier-Fallaktenordner',
        ...
        'folderNew.invalidNhs':
            'Geben Sie eine gültige 10-stellige NHS-Nummer ein (Modulo-11-Prüfung fehlgeschlagen).',
        ...
        'folderNew.patientNameDescription':
            'Nur für einen neuen Patienten erforderlich.',
        'folderNew.dobDescription':
            'Nur für einen neuen Patienten erforderlich.',
        'folderNew.initialCabinet': 'Anfänglicher Schrank',
        'folderNew.initialCabinetDescription':
            'Leer lassen, wenn die Akte im Transit ist.',
        ...
        'patients.tableCaption':
            'Alle Patienten mit einer oder mehreren registrierten Akten',
        ...
        'patientDetail.notFoundHeading':
            'Patient nicht im Haupt-Patientendienst gefunden',
        'patientDetail.notFoundBody':
        ...
        'patientDetail.addFolderForPatient':
            'Eine Akte für diesen Patienten hinzufügen',
        'patientDetail.moveHistoryForPatient':
            'Bewegungsverlauf für diesen Patienten',
        'patientDetail.demoUnavailable':
            '„{action}“ ist in dieser Demo nicht verfügbar.',
        ...
        'buildingNew.intro':
            'Ein Gebäude kann viele Räume haben; jeder Raum kann viele Schränke aufnehmen.',
        ...
        'buildingDetail.presenceIntro':
            'Akten, die in einem Schrank dieses Gebäudes waren, neueste zuerst.',
        'buildingDetail.presenceTable': 'Aktenpräsenzverlauf des Gebäudes',
        'buildingDetail.presenceCaption':
            'Aggregiert über die Schränke dieses Gebäudes',
        'buildingDetail.noPresence':
            'In diesem Gebäude wurde noch keine Aktenpräsenz erfasst.',
        'cabinets.heading': 'Aktenschränke',
        'cabinets.addCabinet': 'Schrank hinzufügen',
        'cabinets.tableLabel': 'Schränke',
        'cabinets.tableCaption':
            'Physische Aktenschränke, ihr Gebäude/Raum und ihre Belegung',
        ...
        'cabinetNew.intro':
            'Ein Schrank befindet sich in einem Raum (der sich in einem Gebäude befindet).',
        'cabinetNew.noRoomsHeading': 'Noch keine Räume vorhanden',
        'cabinetNew.noRoomsBody':
            'zuerst, fügen Sie dann einen Raum von der Gebäudeseite hinzu.',
        ...
        'cabinetNew.capacityDescription':
            'Ungefähre Anzahl der Akten, die der Schrank fasst. Leer lassen, wenn unbekannt.',
        ...
        'cabinetDetail.presenceIntro':
            'Welche Akten in diesem Schrank waren und wann. Neueste zuerst.',
        'cabinetDetail.presenceTable': 'Aktenpräsenzverlauf',
        'cabinetDetail.presenceCaption':
            'Abgeleitet aus dem Bewegungs-Prüfprotokoll',
        'cabinetDetail.colReasonLeft': 'Grund des Verlassens',
        'cabinetDetail.noPresence':
            'In diesem Schrank wurde noch keine Akte erfasst.',
        'roomDetail.backToBuildings': 'Zurück zu Gebäuden',
        'roomDetail.presenceHistory': 'Aktenpräsenzverlauf',
        'roomDetail.presenceIntro':
            'Akten, die in einem Schrank dieses Raums waren, neueste zuerst.',
        'roomDetail.presenceTable': 'Aktenpräsenzverlauf des Raums',
        'roomDetail.presenceCaption':
            'Aggregiert über die Schränke dieses Raums',
        'roomDetail.noPresence':
            'In diesem Raum wurde noch keine Aktenpräsenz erfasst.',
        ...
        'volumes.tableCaption':
            'Bündel von Akten, jedes gehört zu einem Patienten',
        'volumes.colFolders': 'Akten',
        'volumes.colLocation': 'Standort',
        'volumes.noVolumes':
            'Noch keine Bände. Erstellen Sie einen, um die Akten eines Patienten zu bündeln.',
        'volumes.noLabelsSelected': 'Keine Etiketten ausgewählt.',
        'volumes.queued.one':
            '{n} Etikett × {copies} {copy} zum Druck eingereiht.',
        'volumes.queued.other':
            '{n} Etiketten × {copies} {copy} zum Druck eingereiht.',
        'volumes.copy': 'Kopie',
        ...
        'volumeNew.initialCabinetDescription':
            'Wo der Band aufbewahrt wird. Leer lassen, wenn im Transit.',
        ...
        'workerDetail.foldersMoved':
            'Von diesem Mitarbeiter verschobene Akten ({n})',
        'workerDetail.foldersMovedTable':
            'Von diesem Mitarbeiter verschobene Akten',
        'workerDetail.noMovedFolders':
            'Dieser Mitarbeiter hat noch keine Akten verschoben.',
        'workerDetail.patientsFolders': 'Alle Akten ihrer Patienten ({n})',
        'workerDetail.patientsFoldersIntro':
            'Jede Akte eines Patienten, den dieser Mitarbeiter betreut hat.',
        'workerDetail.patientsFoldersTable':
            'Akten der Patienten dieses Mitarbeiters',
        'workerDetail.noPatientFolders':
            'Noch keine Patientenakten anzuzeigen.',
        ...
        'history.filterPlaceholder':
            'Nach Patient, NHS-Nummer, Schrank oder Pförtner filtern',
        'history.filterLabel': 'Prüfprotokoll filtern',
        'history.tableLabel': 'Bewegungs-Prüfprotokoll',
        'history.tableCaption':
            'Jede erfasste Bewegung einer Papierakte, neueste zuerst',
        ...
        'historyDetail.noOtherFolders':
            'Keine anderen Akten für diesen Patienten.',
        ...
        'reports.kpiFoldersDetail':
            '({inCabinet} im Schrank, {inTransit} im Transit)',
        ...
        'reports.derivedLive':
            'Berichte werden live aus der API abgeleitet — kein separater Berichtsspeicher.',
        ...
        'alerts.tableCaption':
            'Grenzüberschreitende Bewegungen, neueste zuerst',
        'alerts.colCrossed': 'Überschritten',
        'alerts.none':
            'Keine Geofence-Verletzungen — jede Akte ist in ihrem Gebäude geblieben.',
    ...
    ru: {
        ...
        'dashboard.inTransit.one':
            'У вас {n} папка сейчас в пути. Используйте страницу',
        'dashboard.inTransit.other':
            'У вас {n} папок сейчас в пути. Используйте страницу',
        ...
        'login.sentBody':
            'соответствует известной учётной записи, ссылка для входа уже в пути. Срок действия ссылки — 10 минут.',
        ...
        'scan.fieldDescription':
            'Номер NHS (например, 943 476 5919) или id папки.',
        ...
        'move.pickFolderDescription':
            'Выберите, какую из папок этого пациента переместить.',
        ...
        'move.workerDescription':
            'Выберите зарегистрированного сотрудника или оставьте пустым, чтобы использовать поле свободного текста ниже.',
        ...
        'move.enterValidNhs':
            'Введите действительный номер NHS, чтобы увидеть папки этого пациента.',
        'move.folderNotFound': 'Папка не найдена.',
        'move.recordedSummary':
            'Записано перемещение {patient} — {folder} из {from} в {to}.',
        'folders.register': 'Реестр папок',
        'folders.searchPlaceholder':
            'Поиск по номеру NHS, пациенту, названию папки или шкафу',
        'folders.searchLabel': 'Поиск папок',
        'folders.addFolder': 'Добавить папку',
        'folders.tableLabel': 'Папки',
        'folders.tableCaption':
            'Все бумажные папки с историями болезни, отслеживаемые системой',
        ...
        'folderNew.invalidNhs':
            'Введите действительный 10-значный номер NHS (проверка по модулю 11 не пройдена).',
        ...
        'folderNew.initialCabinetDescription':
            'Оставьте пустым, если папка в пути.',
        ...
        'patientDetail.addFolderForPatient':
            'Добавить папку для этого пациента',
        'patientDetail.moveHistoryForPatient':
            'История перемещений этого пациента',
        'patientDetail.demoUnavailable':
            '«{action}» недоступно в этой демонстрации.',
        ...
        'buildingNew.intro':
            'В одном здании может быть много комнат; в каждой комнате — много шкафов.',
        ...
        'buildingDetail.presenceIntro':
            'Папки, которые были в любом шкафу этого здания, новейшие первыми.',
        ...
        'buildingDetail.noPresence':
            'В этом здании присутствие папок ещё не зарегистрировано.',
        'cabinets.heading': 'Картотечные шкафы',
        'cabinets.addCabinet': 'Добавить шкаф',
        'cabinets.tableLabel': 'Шкафы',
        'cabinets.tableCaption':
            'Физические картотечные шкафы, их здание/комната и заполненность',
        ...
        'cabinetNew.intro':
            'Шкаф находится в комнате (которая находится в здании).',
        'cabinetNew.noRoomsHeading': 'Комнат ещё нет',
        'cabinetNew.noRoomsBody':
            'сначала, затем добавьте комнату со страницы здания.',
        ...
        'cabinetNew.capacityDescription':
            'Примерное число папок, которое вмещает шкаф. Оставьте пустым, если неизвестно.',
        'cabinetNew.saveCabinet': 'Сохранить шкаф',
        'cabinetDetail.backToCabinets': 'Назад к шкафам',
        'cabinetDetail.currentFolders':
            'Папки, сейчас находящиеся в этом шкафу ({n})',
        ...
        'cabinetDetail.presenceIntro':
            'Какие папки были в этом шкафу и когда. Новейшие первыми.',
        'cabinetDetail.presenceTable': 'История присутствия папок',
        'cabinetDetail.presenceCaption':
            'Получено из журнала аудита перемещений',
        'cabinetDetail.colReasonLeft': 'Причина убытия',
        'cabinetDetail.noPresence':
            'В этом шкафу ещё не зарегистрировано ни одной папки.',
        'roomDetail.backToBuildings': 'Назад к зданиям',
        'roomDetail.presenceHistory': 'История присутствия папок',
        'roomDetail.presenceIntro':
            'Папки, которые были в любом шкафу этой комнаты, новейшие первыми.',
        ...
        'roomDetail.noPresence':
            'В этой комнате присутствие папок ещё не зарегистрировано.',
        ...
        'volumes.tableCaption':
            'Связки папок, каждая принадлежит одному пациенту',
        'volumes.colFolders': 'Папки',
        'volumes.colLocation': 'Местоположение',
        'volumes.noVolumes':
            'Томов пока нет. Создайте один, чтобы связать папки пациента.',
        'volumes.noLabelsSelected': 'Ярлыки не выбраны.',
        'volumes.queued.one':
            '{n} ярлык × {copies} {copy} поставлен в очередь печати.',
        'volumes.queued.other':
            '{n} ярлыков × {copies} {copy} поставлено в очередь печати.',
        'volumes.copy': 'копия',
        ...
        'volumeNew.initialCabinetDescription':
            'Где находится том. Оставьте пустым, если в пути.',
        ...
        'workerDetail.foldersMoved':
            'Папки, перемещённые этим сотрудником ({n})',
        'workerDetail.foldersMovedTable':
            'Папки, перемещённые этим сотрудником',
        'workerDetail.noMovedFolders': 'Этот сотрудник ещё не перемещал папки.',
        'workerDetail.patientsFolders': 'Все папки их пациентов ({n})',
        'workerDetail.patientsFoldersIntro':
            'Каждая папка пациента, которого вёл этот сотрудник.',
        ...
        'history.filterPlaceholder':
            'Фильтр по пациенту, номеру NHS, шкафу или санитару',
        'history.filterLabel': 'Фильтр журнала аудита',
        'history.tableLabel': 'Журнал аудита перемещений',
        'history.tableCaption':
            'Каждое записанное перемещение бумажной папки, новейшие первыми',
        'history.noMatch':
            'Ни одно перемещение не соответствует вашему фильтру.',
        ...
        'reports.derivedLive':
            'Отчёты формируются в реальном времени из API — без отдельного хранилища отчётов.',
        ...
        'alerts.tableCaption':
            'Перемещения с пересечением границ, новейшие первыми',
        'alerts.colCrossed': 'Пересёк',
        'alerts.none':
            'Нарушений геозоны нет — каждая папка осталась в своём здании.',
    ...
    bn: {
        ...
        'dashboard.inTransit.one':
            'আপনার বর্তমানে {n}টি ফোল্ডার স্থানান্তরাধীন আছে। পৃষ্ঠাটি ব্যবহার করুন',
        'dashboard.inTransit.other':
            'আপনার বর্তমানে {n}টি ফোল্ডার স্থানান্তরাধীন আছে। পৃষ্ঠাটি ব্যবহার করুন',
        ...
        'login.sentBody':
            'একটি পরিচিত অ্যাকাউন্টের সাথে মেলে, তবে একটি সাইন-ইন লিঙ্ক পথে আছে। লিঙ্কটি ১০ মিনিটে মেয়াদ শেষ হয়।',
        ...
        'scan.fieldDescription':
            'NHS নম্বর (যেমন 943 476 5919) বা একটি ফোল্ডার id।',
        ...
        'move.pickFolderDescription':
            'এই রোগীর কোন ফোল্ডারটি সরাতে হবে তা বেছে নিন।',
        ...
        'move.workerDescription':
            'একজন নিবন্ধিত কর্মী বেছে নিন, অথবা নিচের ফ্রি-টেক্সট ক্ষেত্র ব্যবহার করতে ফাঁকা রাখুন।',
        ...
        'move.enterValidNhs':
            'এই রোগীর ফোল্ডার দেখতে একটি বৈধ NHS নম্বর লিখুন।',
        'move.folderNotFound': 'ফোল্ডার পাওয়া যায়নি।',
        'move.recordedSummary':
            '{patient}-এর স্থানান্তর রেকর্ড করা হয়েছে — {folder} {from} থেকে {to}।',
        'folders.register': 'ফোল্ডার নিবন্ধ',
        'folders.searchPlaceholder':
            'NHS নম্বর, রোগী, ফোল্ডার শিরোনাম বা ক্যাবিনেট দিয়ে অনুসন্ধান',
        'folders.searchLabel': 'ফোল্ডার অনুসন্ধান',
        'folders.addFolder': 'ফোল্ডার যোগ করুন',
        'folders.tableLabel': 'ফোল্ডার',
        'folders.tableCaption':
            'সিস্টেম দ্বারা ট্র্যাক করা সব কাগজের কেস-নোট ফোল্ডার',
        ...
        'folderNew.invalidNhs':
            'একটি বৈধ ১০-অঙ্কের NHS নম্বর লিখুন (Modulus 11 পরীক্ষা ব্যর্থ)।',
        ...
        'patientDetail.notFoundHeading':
            'প্রধান রোগী সেবায় রোগী পাওয়া যায়নি',
        'patientDetail.notFoundBody':
        ...
        'patientDetail.addFolderForPatient':
            'এই রোগীর জন্য একটি ফোল্ডার যোগ করুন',
        ...
        'buildingNew.intro':
            'একটি ভবনে অনেক কক্ষ থাকতে পারে; প্রতিটি কক্ষে অনেক ক্যাবিনেট থাকতে পারে।',
        ...
        'buildingDetail.presenceIntro':
            'এই ভবনের যেকোনো ক্যাবিনেটে থাকা ফোল্ডার, নতুনতম আগে।',
        'buildingDetail.presenceTable': 'ভবন ফোল্ডার উপস্থিতি ইতিহাস',
        'buildingDetail.presenceCaption':
            'এই ভবনের ক্যাবিনেটগুলোর মধ্যে সমষ্টিগত',
        'buildingDetail.noPresence':
            'এই ভবনে এখনও কোনো ফোল্ডার উপস্থিতি রেকর্ড করা হয়নি।',
        ...
        'cabinetNew.intro':
            'একটি ক্যাবিনেট একটি কক্ষের ভিতরে থাকে (যা একটি ভবনের ভিতরে থাকে)।',
        'cabinetNew.noRoomsHeading': 'এখনও কোনো কক্ষ নেই',
        'cabinetNew.noRoomsBody':
            'প্রথমে, তারপর ভবনের পৃষ্ঠা থেকে একটি কক্ষ যোগ করুন।',
        ...
        'cabinetNew.capacityDescription':
            'ক্যাবিনেটটি ধারণ করা ফোল্ডারের আনুমানিক সংখ্যা। অজানা হলে ফাঁকা রাখুন।',
        'cabinetNew.saveCabinet': 'ক্যাবিনেট সংরক্ষণ করুন',
        'cabinetDetail.backToCabinets': 'ক্যাবিনেটে ফিরুন',
        'cabinetDetail.currentFolders':
            'এই ক্যাবিনেটে বর্তমানে থাকা ফোল্ডার ({n})',
        ...
        'cabinetDetail.presenceIntro':
            'কোন ফোল্ডারগুলো এই ক্যাবিনেটে ছিল, এবং কখন। নতুনতম আগে।',
        ...
        'volumes.noVolumes':
            'এখনও কোনো খণ্ড নেই। একজন রোগীর ফোল্ডার বান্ডিল করতে একটি তৈরি করুন।',
        'volumes.noLabelsSelected': 'কোনো লেবেল নির্বাচিত নয়।',
        'volumes.queued.one':
            'প্রিন্টের জন্য {n}টি লেবেল × {copies} {copy} সারিবদ্ধ করা হয়েছে।',
        'volumes.queued.other':
            'প্রিন্টের জন্য {n}টি লেবেল × {copies} {copy} সারিবদ্ধ করা হয়েছে।',
        'volumes.copy': 'কপি',
        'volumes.copies': 'কপি',
        ...
        'volumeNew.initialCabinetDescription':
            'খণ্ডটি যেখানে থাকে। স্থানান্তরাধীন হলে ফাঁকা রাখুন।',
        ...
        'workerDetail.patientsFoldersIntro':
            'এই কর্মী যে রোগীকে সামলেছেন তাঁর প্রতিটি ফোল্ডার।',
        'workerDetail.patientsFoldersTable': 'এই কর্মীর রোগীদের ফোল্ডার',
        'workerDetail.noPatientFolders':
            'দেখানোর জন্য এখনও কোনো রোগী ফোল্ডার নেই।',
        ...
        'history.filterPlaceholder':
            'রোগী, NHS নম্বর, ক্যাবিনেট বা পোর্টার দিয়ে ফিল্টার করুন',
        'history.filterLabel': 'নিরীক্ষা লগ ফিল্টার করুন',
        'history.tableLabel': 'স্থানান্তর নিরীক্ষা লগ',
        'history.tableCaption':
            'একটি কাগজের ফোল্ডারের প্রতিটি রেকর্ড করা স্থানান্তর, নতুনতম আগে',
        ...
        'reports.kpiFoldersDetail':
            '({inCabinet} ক্যাবিনেটে, {inTransit} স্থানান্তরাধীন)',
        ...
        'reports.derivedLive':
            'প্রতিবেদন API থেকে সরাসরি উদ্ভূত — কোনো পৃথক প্রতিবেদন স্টোর নেই।',
        ...
        'alerts.none':
            'কোনো জিওফেন্স লঙ্ঘন নেই — প্রতিটি ফোল্ডার তার ভবনের মধ্যে থেকেছে।',
    ...
    pt: {
        ...
        'dashboard.inTransit.one':
            'Tem {n} pasta atualmente em trânsito. Use a página',
        'dashboard.inTransit.other':
            'Tem {n} pastas atualmente em trânsito. Use a página',
        ...
        'login.sentBody':
            'corresponder a uma conta conhecida, um link de início de sessão está a caminho. O link expira em 10 minutos.',
        'login.sentPrefix': 'Se',
        ...
        'callback.completing':
            'Um momento — a concluir o seu início de sessão…',
        ...
        'scan.fieldDescription':
            'Número NHS (p. ex. 943 476 5919) ou um id de pasta.',
        ...
        'move.pickFolderDescription':
            'Escolha qual das pastas deste paciente mover.',
        'move.enterNhsDescription':
            'Introduza um Número NHS para ver as pastas.',
        'move.selectFolderOption': '— Selecionar pasta —',
        'move.destination': 'Destino',
        'move.workerLabel':
            'Funcionário (do Serviço Principal de Funcionários)',
        'move.workerDescription':
            'Escolha um funcionário registado, ou deixe em branco para usar o campo de texto livre abaixo.',
        'move.freeTextOnly': '— Apenas texto livre —',
        'move.movedByLabel': 'Movido por (texto livre)',
        'move.movedByDescription':
            'Usado quando nenhum funcionário é selecionado.',
        ...
        'move.enterValidNhs':
            'Introduza um Número NHS válido para ver as pastas deste paciente.',
        'move.folderNotFound': 'Pasta não encontrada.',
        'move.recordedSummary':
            'Movimentação registada de {patient} — {folder} de {from} para {to}.',
        'folders.register': 'Registo de pastas',
        'folders.searchPlaceholder':
            'Pesquisar por Número NHS, paciente, título da pasta ou armário',
        'folders.searchLabel': 'Pesquisar pastas',
        'folders.addFolder': 'Adicionar pasta',
        'folders.tableLabel': 'Pastas',
        'folders.tableCaption':
            'Todas as pastas de notas de processo em papel rastreadas pelo sistema',
        ...
        'folderNew.invalidNhs':
            'Introduza um Número NHS válido de 10 dígitos (verificação Módulo 11 falhou).',
        ...
        'patients.tableLabel': 'Pacientes',
        'patients.tableCaption':
            'Todos os pacientes com uma ou mais pastas registadas',
        ...
        'patientDetail.notFoundHeading':
            'Paciente não encontrado no Serviço Principal de Pacientes',
        'patientDetail.notFoundBody':
        ...
        'patientDetail.addFolderForPatient':
            'Adicionar uma pasta para este paciente',
        'patientDetail.moveHistoryForPatient':
            'Histórico de movimentações deste paciente',
        'patientDetail.demoUnavailable':
            '“{action}” não está disponível nesta demonstração.',
        'buildings.heading': 'Edifícios',
        'buildings.addBuilding': 'Adicionar edifício',
        'buildings.tableLabel': 'Edifícios',
        'buildings.tableCaption':
            'Locais físicos que albergam salas de arquivo',
        'buildings.colRooms': 'Salas',
        ...
        'buildingNew.intro':
            'Um edifício pode ter muitas salas; cada sala pode conter muitos armários.',
        ...
        'buildingDetail.presenceIntro':
            'Pastas que estiveram em qualquer armário deste edifício, mais recentes primeiro.',
        'buildingDetail.presenceTable':
            'Histórico de presença de pastas do edifício',
        'buildingDetail.presenceCaption':
            'Agregado pelos armários deste edifício',
        'buildingDetail.noPresence':
            'Ainda não foi registada presença de pastas neste edifício.',
        'cabinets.heading': 'Armários de arquivo',
        'cabinets.addCabinet': 'Adicionar armário',
        'cabinets.tableLabel': 'Armários',
        'cabinets.tableCaption':
            'Armários de arquivo físicos, o seu edifício/sala e ocupação',
        'cabinets.colLabel': 'Etiqueta',
        ...
        'cabinetNew.intro':
            'Um armário fica dentro de uma sala (que fica dentro de um edifício).',
        'cabinetNew.noRoomsHeading': 'Ainda não existem salas',
        'cabinetNew.noRoomsBody':
            'primeiro, depois adicione uma sala a partir da página do edifício.',
        ...
        'cabinetNew.capacityDescription':
            'Número aproximado de pastas que o armário contém. Deixe em branco se desconhecido.',
        ...
        'cabinetDetail.presenceIntro':
            'Que pastas estiveram neste armário, e quando. Mais recentes primeiro.',
        'cabinetDetail.presenceTable': 'Histórico de presença de pastas',
        'cabinetDetail.presenceCaption':
            'Derivado do registo de auditoria de movimentações',
        'cabinetDetail.colReasonLeft': 'Motivo da saída',
        'cabinetDetail.noPresence':
            'Ainda não foi registada nenhuma pasta neste armário.',
        'roomDetail.backToBuildings': 'Voltar aos edifícios',
        'roomDetail.presenceHistory': 'Histórico de presença de pastas',
        'roomDetail.presenceIntro':
            'Pastas que estiveram em qualquer armário desta sala, mais recentes primeiro.',
        ...
        'roomDetail.noPresence':
            'Ainda não foi registada presença de pastas nesta sala.',
        'volumes.heading': 'Volumes',
        'volumes.printLabels': 'Imprimir etiquetas',
        ...
        'volumes.tableLabel': 'Volumes',
        'volumes.tableCaption':
            'Conjuntos de pastas, cada um pertencente a um paciente',
        'volumes.colFolders': 'Pastas',
        'volumes.colLocation': 'Localização',
        'volumes.noVolumes':
            'Ainda não há volumes. Crie um para agrupar as pastas de um paciente.',
        'volumes.noLabelsSelected': 'Nenhuma etiqueta selecionada.',
        'volumes.queued.one':
            '{n} etiqueta × {copies} {copy} colocada na fila de impressão.',
        'volumes.queued.other':
            '{n} etiquetas × {copies} {copy} colocadas na fila de impressão.',
        'volumes.copy': 'cópia',
        ...
        'volumeNew.initialCabinetDescription':
            'Onde o volume está. Deixe em branco se em trânsito.',
        ...
        'volumeDetail.moveIntro':
            'Reposiciona todas as pastas do volume em conjunto.',
        ...
        'workers.tableCaption':
            'Funcionários do Serviço Principal de Funcionários',
        'workers.noWorkers': 'Nenhum funcionário encontrado.',
        'workerDetail.backToWorkers': 'Voltar aos funcionários',
        'workerDetail.foldersMoved':
            'Pastas movidas por este funcionário ({n})',
        'workerDetail.foldersMovedTable': 'Pastas movidas por este funcionário',
        'workerDetail.noMovedFolders':
            'Este funcionário ainda não moveu nenhuma pasta.',
        'workerDetail.patientsFolders':
            'Todas as pastas dos seus pacientes ({n})',
        'workerDetail.patientsFoldersIntro':
            'Cada pasta pertencente a um paciente que este funcionário tratou.',
        'workerDetail.patientsFoldersTable':
            'Pastas dos pacientes deste funcionário',
        'workerDetail.noPatientFolders':
            'Ainda não há pastas de pacientes para mostrar.',
        ...
        'history.filterPlaceholder':
            'Filtrar por paciente, número NHS, armário ou maqueiro',
        'history.filterLabel': 'Filtrar registo de auditoria',
        'history.tableLabel': 'Registo de auditoria de movimentações',
        'history.tableCaption':
            'Cada movimentação registada de uma pasta em papel, mais recentes primeiro',
        ...
        'historyDetail.noOtherFolders':
            'Não há outras pastas para este paciente.',
        ...
        'reports.kpiFoldersDetail':
            '({inCabinet} no armário, {inTransit} em trânsito)',
        'reports.kpiVolumes': 'Volumes:',
        ...
        'reports.derivedLive':
            'Os relatórios são derivados em tempo real da API — sem armazenamento de relatórios separado.',
        ...
        'alerts.tableCaption':
            'Movimentações que atravessam limites, mais recentes primeiro',
        'alerts.colCrossed': 'Atravessou',
        'alerts.none':
            'Sem violações de geofence — cada pasta permaneceu dentro do seu edifício.',
    ...
    id: {
        ...
        'dashboard.inTransit.one':
            'Anda memiliki {n} folder yang sedang dalam perjalanan. Gunakan halaman',
        'dashboard.inTransit.other':
            'Anda memiliki {n} folder yang sedang dalam perjalanan. Gunakan halaman',
        ...
        'login.sentBody':
            'cocok dengan akun yang dikenal, tautan masuk sedang dalam perjalanan. Tautan kedaluwarsa dalam 10 menit.',
        ...
        'scan.fieldDescription':
            'Nomor NHS (mis. 943 476 5919) atau id folder.',
        ...
        'move.pickFolderDescription':
            'Pilih folder pasien ini mana yang akan dipindahkan.',
        ...
        'move.workerDescription':
            'Pilih pekerja terdaftar, atau biarkan kosong untuk menggunakan bidang teks bebas di bawah.',
        'move.freeTextOnly': '— Hanya teks bebas —',
        'move.movedByLabel': 'Dipindahkan oleh (teks bebas)',
        'move.movedByDescription':
            'Digunakan saat tidak ada pekerja yang dipilih.',
        ...
        'move.enterValidNhs':
            'Masukkan Nomor NHS yang valid untuk melihat folder pasien ini.',
        'move.folderNotFound': 'Folder tidak ditemukan.',
        'move.recordedSummary':
            'Perpindahan {patient} dicatat — {folder} dari {from} ke {to}.',
        'folders.register': 'Daftar folder',
        'folders.searchPlaceholder':
            'Cari berdasarkan Nomor NHS, pasien, judul folder, atau lemari',
        'folders.searchLabel': 'Cari folder',
        'folders.addFolder': 'Tambah folder',
        'folders.tableLabel': 'Folder',
        'folders.tableCaption':
            'Semua folder catatan kasus kertas yang dilacak oleh sistem',
        ...
        'folderNew.invalidNhs':
            'Masukkan Nomor NHS 10 digit yang valid (pemeriksaan Modulus 11 gagal).',
        ...
        'patients.tableCaption':
            'Semua pasien dengan satu atau lebih folder terdaftar',
        ...
        'patientDetail.notFoundHeading':
            'Pasien tidak ditemukan di Layanan Pasien Utama',
        'patientDetail.notFoundBody':
        ...
        'patientDetail.moveHistoryForPatient':
            'Riwayat perpindahan untuk pasien ini',
        'patientDetail.demoUnavailable':
            '“{action}” tidak tersedia dalam demo ini.',
        ...
        'buildingNew.intro':
            'Satu bangunan dapat memiliki banyak ruang; setiap ruang dapat menampung banyak lemari.',
        ...
        'buildingDetail.presenceIntro':
            'Folder yang pernah berada di lemari mana pun di bangunan ini, terbaru lebih dulu.',
        'buildingDetail.presenceTable': 'Riwayat keberadaan folder bangunan',
        'buildingDetail.presenceCaption':
            'Diagregasi di seluruh lemari bangunan ini',
        'buildingDetail.noPresence':
            'Belum ada keberadaan folder yang dicatat di bangunan ini.',
        'cabinets.heading': 'Lemari arsip',
        'cabinets.addCabinet': 'Tambah lemari',
        'cabinets.tableLabel': 'Lemari',
        'cabinets.tableCaption':
            'Lemari arsip fisik, bangunan/ruangnya, dan tingkat hunian',
        'cabinets.colLabel': 'Label',
        ...
        'cabinetNew.intro':
            'Sebuah lemari berada di dalam ruang (yang berada di dalam bangunan).',
        'cabinetNew.noRoomsHeading': 'Belum ada ruang',
        'cabinetNew.noRoomsBody':
            'terlebih dahulu, lalu tambahkan ruang dari halaman bangunan.',
        ...
        'cabinetNew.capacityDescription':
            'Perkiraan jumlah folder yang ditampung lemari. Biarkan kosong jika tidak diketahui.',
        'cabinetNew.saveCabinet': 'Simpan lemari',
        'cabinetDetail.backToCabinets': 'Kembali ke lemari',
        'cabinetDetail.currentFolders':
            'Folder yang saat ini berada di lemari ini ({n})',
        ...
        'cabinetDetail.presenceIntro':
            'Folder mana yang pernah berada di lemari ini, dan kapan. Terbaru lebih dulu.',
        'cabinetDetail.presenceTable': 'Riwayat keberadaan folder',
        'cabinetDetail.presenceCaption':
            'Diturunkan dari log audit perpindahan',
        'cabinetDetail.colReasonLeft': 'Alasan keluar',
        'cabinetDetail.noPresence':
            'Belum ada folder yang dicatat di lemari ini.',
        'roomDetail.backToBuildings': 'Kembali ke bangunan',
        'roomDetail.presenceHistory': 'Riwayat keberadaan folder',
        'roomDetail.presenceIntro':
            'Folder yang pernah berada di lemari mana pun di ruang ini, terbaru lebih dulu.',
        ...
        'roomDetail.noPresence':
            'Belum ada keberadaan folder yang dicatat di ruang ini.',
        ...
        'volumes.tableCaption':
            'Bundel folder, masing-masing milik satu pasien',
        'volumes.colFolders': 'Folder',
        'volumes.colLocation': 'Lokasi',
        'volumes.noVolumes':
            'Belum ada jilid. Buat satu untuk membundel folder pasien.',
        'volumes.noLabelsSelected': 'Tidak ada label yang dipilih.',
        'volumes.queued.one':
            '{n} label × {copies} {copy} diantrikan untuk dicetak.',
        'volumes.queued.other':
            '{n} label × {copies} {copy} diantrikan untuk dicetak.',
        ...
        'volumeNew.initialCabinetDescription':
            'Tempat jilid berada. Biarkan kosong jika dalam perjalanan.',
        ...
        'volumeDetail.moveIntro':
            'Memindahkan semua folder dalam jilid bersama-sama.',
        ...
        'workerDetail.foldersMoved':
            'Folder yang dipindahkan oleh pekerja ini ({n})',
        'workerDetail.foldersMovedTable':
            'Folder yang dipindahkan oleh pekerja ini',
        'workerDetail.noMovedFolders':
            'Pekerja ini belum memindahkan folder apa pun.',
        'workerDetail.patientsFolders': 'Semua folder pasien mereka ({n})',
        'workerDetail.patientsFoldersIntro':
            'Setiap folder milik pasien yang telah ditangani pekerja ini.',
        'workerDetail.patientsFoldersTable': 'Folder pasien pekerja ini',
        'workerDetail.noPatientFolders':
            'Belum ada folder pasien untuk ditampilkan.',
        ...
        'history.filterPlaceholder':
            'Filter berdasarkan pasien, nomor NHS, lemari, atau porter',
        'history.filterLabel': 'Filter log audit',
        'history.tableLabel': 'Log audit perpindahan',
        'history.tableCaption':
            'Setiap perpindahan folder kertas yang dicatat, terbaru lebih dulu',
        'history.noMatch':
            'Tidak ada perpindahan yang cocok dengan filter Anda.',
        ...
        'historyDetail.noOtherFolders':
            'Tidak ada folder lain untuk pasien ini.',
        ...
        'reports.kpiFoldersDetail':
            '({inCabinet} di lemari, {inTransit} dalam perjalanan)',
        ...
        'reports.derivedLive':
            'Laporan diturunkan secara langsung dari API — tanpa penyimpanan laporan terpisah.',
        ...
        'alerts.none':
            'Tidak ada pelanggaran geofence — setiap folder tetap berada di dalam bangunannya.',
    ...
    ur: {
        ...
        'dashboard.inTransit.one':
            'آپ کے پاس اس وقت {n} فولڈر زیر منتقلی ہے۔ صفحہ استعمال کریں',
        'dashboard.inTransit.other':
            'آپ کے پاس اس وقت {n} فولڈرز زیر منتقلی ہیں۔ صفحہ استعمال کریں',
        ...
        'login.sentBody':
            'کسی معلوم اکاؤنٹ سے میل کھاتا ہے، تو سائن ان لنک راستے میں ہے۔ لنک 10 منٹ میں ختم ہو جاتا ہے۔',
        ...
        'scan.fieldDescription':
            'NHS نمبر (مثلاً 943 476 5919) یا ایک فولڈر id۔',
        ...
        'move.pickFolderDescription':
            'منتخب کریں کہ اس مریض کے کون سے فولڈرز منتقل کرنے ہیں۔',
        ...
        'move.workerDescription':
            'ایک رجسٹرڈ کارکن منتخب کریں، یا نیچے دیے گئے آزاد متن خانے کو استعمال کرنے کے لیے خالی چھوڑ دیں۔',
        'move.freeTextOnly': '— صرف آزاد متن —',
        'move.movedByLabel': 'منتقل کردہ بذریعہ (آزاد متن)',
        'move.movedByDescription':
            'جب کوئی کارکن منتخب نہ ہو تو استعمال ہوتا ہے۔',
        ...
        'move.enterValidNhs':
            'اس مریض کے فولڈرز دیکھنے کے لیے ایک درست NHS نمبر درج کریں۔',
        'move.folderNotFound': 'فولڈر نہیں ملا۔',
        'move.recordedSummary':
            '{patient} کی منتقلی ریکارڈ ہو گئی — {folder} {from} سے {to} تک۔',
        'folders.register': 'فولڈر رجسٹر',
        'folders.searchPlaceholder':
            'NHS نمبر، مریض، فولڈر عنوان، یا الماری سے تلاش کریں',
        'folders.searchLabel': 'فولڈرز تلاش کریں',
        'folders.addFolder': 'فولڈر شامل کریں',
        'folders.tableLabel': 'فولڈرز',
        'folders.tableCaption':
            'سسٹم کے ذریعے ٹریک کیے گئے تمام کاغذی کیس نوٹ فولڈرز',
        ...
        'folderNew.invalidNhs':
            'ایک درست 10 ہندسوں کا NHS نمبر درج کریں (Modulus 11 جانچ ناکام)۔',
        ...
        'folderNew.initialCabinetDescription':
            'اگر فولڈر زیر منتقلی ہے تو خالی چھوڑ دیں۔',
        ...
        'patientDetail.addFolderForPatient':
            'اس مریض کے لیے ایک فولڈر شامل کریں',
        'patientDetail.moveHistoryForPatient': 'اس مریض کی منتقلی کی تاریخ',
        'patientDetail.demoUnavailable':
            '“{action}” اس ڈیمو میں دستیاب نہیں ہے۔',
        ...
        'buildingNew.intro':
            'ایک عمارت میں کئی کمرے ہو سکتے ہیں؛ ہر کمرے میں کئی الماریاں ہو سکتی ہیں۔',
        ...
        'cabinetNew.intro':
            'ایک الماری ایک کمرے کے اندر ہوتی ہے (جو ایک عمارت کے اندر ہوتا ہے)۔',
        'cabinetNew.noRoomsHeading': 'ابھی تک کوئی کمرہ موجود نہیں',
        'cabinetNew.noRoomsBody':
            'پہلے، پھر عمارت کے صفحے سے ایک کمرہ شامل کریں۔',
        ...
        'cabinetNew.capacityDescription':
            'الماری جتنے فولڈرز رکھتی ہے اس کی تخمینی تعداد۔ نامعلوم ہونے پر خالی چھوڑ دیں۔',
        'cabinetNew.saveCabinet': 'الماری محفوظ کریں',
        'cabinetDetail.backToCabinets': 'الماریوں پر واپس',
        'cabinetDetail.currentFolders':
            'اس وقت اس الماری میں موجود فولڈرز ({n})',
        ...
        'cabinetDetail.presenceIntro':
            'کون سے فولڈرز اس الماری میں رہے ہیں، اور کب۔ تازہ ترین پہلے۔',
        ...
        'volumes.noVolumes':
            'ابھی تک کوئی جلد نہیں۔ کسی مریض کے فولڈرز بنڈل کرنے کے لیے ایک بنائیں۔',
        'volumes.noLabelsSelected': 'کوئی لیبل منتخب نہیں۔',
        'volumes.queued.one':
            'پرنٹ کے لیے {n} لیبل × {copies} {copy} قطار میں۔',
        'volumes.queued.other':
            'پرنٹ کے لیے {n} لیبل × {copies} {copy} قطار میں۔',
        'volumes.copy': 'نقل',
        'volumes.copies': 'نقول',
        ...
        'volumeNew.initialCabinetDescription':
            'جہاں جلد رہتی ہے۔ زیر منتقلی ہونے پر خالی چھوڑ دیں۔',
        ...
        'volumeDetail.moveIntro':
            'جلد کے تمام فولڈرز کو ایک ساتھ منتقل کرتا ہے۔',
        ...
        'workerDetail.noMovedFolders':
            'اس کارکن نے ابھی تک کوئی فولڈر منتقل نہیں کیا۔',
        'workerDetail.patientsFolders': 'ان کے مریضوں کے تمام فولڈرز ({n})',
        'workerDetail.patientsFoldersIntro':
            'اس کارکن کے سنبھالے ہوئے مریض کا ہر فولڈر۔',
        'workerDetail.patientsFoldersTable': 'اس کارکن کے مریضوں کے فولڈرز',
        'workerDetail.noPatientFolders':
            'دکھانے کے لیے ابھی تک کوئی مریض فولڈر نہیں۔',
        ...
        'history.filterPlaceholder':
            'مریض، NHS نمبر، الماری، یا پورٹر سے فلٹر کریں',
        'history.filterLabel': 'آڈٹ لاگ فلٹر کریں',
        'history.tableLabel': 'منتقلی آڈٹ لاگ',
        'history.tableCaption':
            'کاغذی فولڈر کی ہر ریکارڈ شدہ منتقلی، تازہ ترین پہلے',
        ...
        'reports.kpiFoldersDetail':
            '({inCabinet} الماری میں، {inTransit} زیر منتقلی)',
        ...
        'reports.derivedLive':
            'رپورٹس API سے براہ راست اخذ کی جاتی ہیں — کوئی الگ رپورٹنگ اسٹور نہیں۔',
        ...
        'alerts.none':
            'کوئی جیو فینس خلاف ورزی نہیں — ہر فولڈر اپنی عمارت کے اندر رہا ہے۔',
