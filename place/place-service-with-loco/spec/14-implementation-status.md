...
| Tests | 141 unit + 86 integration (incl. 14 bridge) + 16 Criterion benchmarks |
...
| GeoJSON export | T-7 |
| Authentication — roles + boot-time HTTP key fetch (peer PASETO verification and default-off blanket enforcement delivered) | T-8 |
