...
| Tests | 143 unit + 86 integration (incl. 14 bridge) + 16 Criterion benchmarks |
...
| GeoJSON export | T-7 |
| Authentication — roles (peer PASETO verification, default-off blanket enforcement, and boot-time HTTP key fetch delivered) | T-8 |
