...
| **GeoCoordinates** | `{ latitude_as_decimal_degrees, longitude_as_decimal_degrees, elevation_as_decimal_metres? }` in WGS 84 decimal degrees, held as exact decimals (`BigDecimal` / `NUMERIC`), not binary floats — see spec §5.2.1 |
