...
| Security | Offline PASETO v4.public bearer verification against the auth-service published Ed25519 keys (opt-in per handler; blanket enforcement is the T-8 remainder); TLS at the edge |
