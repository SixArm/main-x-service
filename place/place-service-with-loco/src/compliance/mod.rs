//! Compliance controls: row-level integrity for place records and
//! the audit trail.
//!
//! ## What is here, and what is deliberately not
//!
//! Each place record and each `audit_log` row carries three stored
...
//! since it was written, and says noplace about a row that was **deleted
//! wholesale**. Adding the chain is a separate, larger control and is not
//! claimed by anyplace in this module.
//!
//! ## Default off
//!
//! With no `PLACE_INTEGRITY_MAC_KEY` (or `..._KEY_FILE`)
...
/// Row-level integrity hashing over the assembled `Place` record.
