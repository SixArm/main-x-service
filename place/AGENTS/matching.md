...
| **In-service scorer** (`matching::scoring::compute_match`) | `place-service-with-loco/src/matching/` | The service's own weighted scorer over the service model ([service AGENTS/matching.md](../place-service-with-loco/AGENTS/matching.md)) |
...
- **Confidence:** Certain ≥ 0.95 · Probable ≥ 0.80 · Possible ≥ 0.60 ·
  Unlikely below.
- Full reference:
  [service AGENTS/matching.md](../place-service-with-loco/AGENTS/matching.md).
...
[spec §6.2](../place-service-with-loco/spec/06-functional-requirements.md)).
