...
|---|---|---|
| [place-service-with-loco](../place-service-with-loco/) | Rust service (loco.rs / Axum, SeaORM, Tantivy) | System of record: CRUD, search, geo-radius, duplicate detection, merge, review queue, validation, privacy, audit, events, REST API |
...
```bash
# place-service-with-loco — REST API on :8080, Swagger at /swagger-ui
...
|---|---|---|---|
| place-service | [spec/](../place-service-with-loco/spec/index.md) (§1–§18) | [AGENTS.md](../place-service-with-loco/AGENTS.md) | [AGENTS/](../place-service-with-loco/AGENTS/index.md) |
