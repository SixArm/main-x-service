# AGENTS directory — Place Service

Detailed reference documentation for the Place Service crate.
...
| [models.md](models.md) | Domain model reference (`Place`, supporting types, invariants) |
