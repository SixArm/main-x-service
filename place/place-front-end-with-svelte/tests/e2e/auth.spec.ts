// E2E coverage for /signin and /verify (T-26) — the magic-link BFF flow
...
test.describe("Sign-in / verify (T-26)", () => {
  ...
  // Pins the fix: before it, an unreachable authentication service made
  // `load` throw uncaught, and SvelteKit rendered its generic 500 page
  // instead of this route's own UI — confirmed directly by reproducing
  // the scenario against a real (reset) connection before fixing it.
