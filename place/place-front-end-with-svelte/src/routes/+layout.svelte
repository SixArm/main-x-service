<script lang="ts">
    ...
    const navItems = [
        ...
        { href: "/places/new", label: "New place" },
        { href: "/places/match", label: "Match check" },
        { href: "/places/merge", label: "Merge" },
    ];
</script>

<div class="layout">
    <aside class="sidebar">
        <h1 class="brand">Place<br /><span class="muted small">Main X Index</span></h1>
        <nav>
            <ul>
